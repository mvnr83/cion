...
<li><a href="microsoft_solutions.php" title="Microsoft Office Solutions">Microsoft Office Solutions</a></li>
                ...
                <li> <a href="active-directory-tools.php"  title="Cion Products">Products</a>
...
-->
          ...
          <!--              <a href="http://www.cionsystems.com/LiveSupport/client.php?locale=en" target="_blank" onClick="if(navigator.userAgent.toLowerCase().indexOf('opera') != -1 && window.event.preventDefault) window.event.preventDefault();this.newWindow = window.open('http://www.cionsystems.com/LiveSupport/client.php?locale=en&url='+escape(document.location.href)+'&referrer='+escape(document.referrer), 'webim', 'toolbar=0,scrollbars=0,location=0,status=1,menubar=0,width=640,height=480,resizable=1');this.newWindow.focus();this.newWindow.opener=window;return false;">
			...
			<div id="hover-box">
				...
				<ul>
					<li><a href="#1" class="highlight"><img src="images/SlideImages/mlb-1-thumb.jpg" alt="Caption 1" width="59" height="41" /><span></span></a></li>
					<li><a href="#2"><img src="images/SlideImages/mlb-2-thumb.jpg" alt="Caption 2" width="59" height="41" /></a></li>
					<li><a href="#3"><img src="images/SlideImages/mlb-3-thumb.jpg" alt="Caption 3" width="59" height="41" /></a></li>
					<li><a href="#4"><img src="images/SlideImages/mlb-4-thumb.jpg" alt="Caption 4" width="59" height="41" /></a></li>
					<li><a href="#5"><img src="images/SlideImages/mlb-5-thumb.jpg" alt="Caption 5" width="59" height="41" /></a></li>
					<li><a href="#6"><img src="images/SlideImages/mlb-6-thumb.jpg" alt="Caption 6" width="59" height="41" /></a></li>
                    <li><a href="#7"><img src="images/SlideImages/mlb-7-thumb.jpg" alt="Caption 7" width="59" height="41" /></a></li>
                    <li><a href="#8"><img src="images/SlideImages/mlb-8-thumb.jpg" alt="Caption 8" width="59" height="41" /></a></li>
				</ul>
