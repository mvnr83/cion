...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #006699;">
  ...
  <tr>
    <td height="86" style="padding:10px;"><p>Thank you for registering and downloading the CionSystems '.$fetch[product_name].'. A sales representative will be contacting you shortly to discuss the challenges facing you and your organization and how we can help. In the meantime,';
if($fetch[product_code]=="sic"){$message.='please feel free to download this evaluation version to gain more knowledge about the benefits and features of our management solutions.</p></td>
			...
			'<tr>
				<td style="padding:10px;">Please review the requirements and our Quick Start guide, before installing the application:<br />
				<a href="http://www.cionsystems.com/trial/Self_service_Quick_Start_v3.0.0.3.pdf"><img src="http://www.cionsystems.com/images/quickstart.gif" alt="Quick Start Guide" border="0" /></a></td>
			</tr>';
