...
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="grstr1left">
          <tr>
            <td colspan="3" align="left" valign="top"><table width="100%" height="32" border="0" align="left" cellpadding="0" cellspacing="0" background="images/inner_headingbg.gif" class="whitestr">
                ...
                <tr>
                  <td width="2%">&nbsp;</td>
                  <td width="50%" align="left" valign="middle" class="hea">My Account </td><br />
				  <td width="50%" align="right" valign="middle" class="hea">&nbsp; </td>
                </tr>
            </table></td>
          </tr>
          <tr>
          ...
          <tr>
            <td align="left" valign="top">  <table width="102%" border="0" align="center" cellpadding="0" cellspacing="4">
                  
                <tr>
                    <td colspan="2" align="left" valign="top" class="black1">&nbsp;</td>
              </tr>
				  <tr>
				  	<td width="14%" class="black">Order Id</td>
				  	<td width="42%" class="black">Product Name</td>
					<td width="18%" class="black">Status</td>
					<td width="26%" class="black">Posted Date</td>
				 </tr>
				 {section name=list loop=$parray}
				 <tr>
				 	<td class="black1" align="center">{$parray[list].id}</td>
					<td class="black1">{$name[list]}</td>
					<td class="black1">{$parray[list].status}</td>
					<td class="black1">{$parray[list].date|date_format}</td>
				 </tr>
				  {/section}
				  </table>
            </td>
            <td align="left" valign="top"><form name="form1" method="post" action="" onSubmit="javascript:return validate();">
		 <input type="hidden" name="act">
                ...
                -->
                  <tr>
                    <td width="48%" align="center" valign="middle" class="hea" colspan="2">Personal Information : </td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="ver11" nowrap="nowrap"><span class="red">*</span>Email Address:</td>
                    <td align="left" valign="middle"><input name="email" type="text" class="fieldwidthbig" value="{$array[0].email}"></td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="ver11" nowrap="nowrap"><span class="red">*</span>First Name:</td>
                    <td align="left" valign="middle"><input name="fname" type="text" class="fieldwidthbig" value="{$array[0].first_name}">
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="ver11" nowrap="nowrap"><span class="red">*</span>Last Name:</td>
                    <td align="left" valign="middle"><input name="lname" type="text" class="fieldwidthbig" value="{$array[0].last_name}"></td>
                  </tr>
				  <tr>
                    <td align="right" valign="middle" class="ver11" nowrap="nowrap"><span class="red">*</span>User Name:</td>
                    <td align="left" valign="middle"><input name="uname" type="text" class="fieldwidthbig" value="{$array[0].user_name}" readonly="true">
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="ver11"><span class="red">*</span>Password:</td>
                    <td align="left" valign="middle"><input name="pwd" type="password" class="fieldwidthbig" value="{$array[0].password}" readonly="true"></td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="ver11"><span class="red">*</span>Country:</td>
                  ...
                  <tr>
                    <td align="center" valign="middle" class="hea" colspan="2" nowrap="nowrap">Company Information : </td>
                    <td align="left" valign="middle">&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="ver11" nowrap="nowrap"><span class="red">*</span> Company : </td>
                    <td align="left" valign="middle"><input name="company" type="text" class="fieldwidthbig" value="{$array[0].company}"></td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="ver11" nowrap="nowrap"><span class="red">*</span> Job Title : </td>
                  ...
                  <tr>
                    <td align="right" valign="middle" class="ver11" nowrap="nowrap"><span class="red">*</span> Industry : </td>
                  ...
                  <tr>
                    <td align="right" valign="middle" class="ver11" nowrap="nowrap"><span class="red">*</span> Address 1 : </td>
                    <td align="left" valign="middle"><input name="address1" type="text" class="fieldwidthbig" value="{$array[0].address1}"></td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="ver11" nowrap="nowrap">Address 2 :</td>
                    <td align="left" valign="middle"><input name="address2" type="text" class="fieldwidthbig" value="{$array[0].address2}"></td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="ver11"><span class="red">*</span> City : </td>
                    <td align="left" valign="middle"><input name="city" type="text" class="fieldwidthbig" value="{$array[0].city}"></td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="ver11" nowrap="nowrap">State Province: </td>
                    <td align="left" valign="middle"><input name="state" type="text" class="fieldwidthbig" value="{$array[0].state}"></td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="ver11">Postal Code:</td>
                    <td align="left" valign="middle"><input name="pcode" type="text" maxlength="10" value="{$array[0].zipcode}"></td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="ver11"><span class="red">*</span> Phone:</td>
                    <td align="left" valign="middle"><input name="phone" type="text" class="fieldwidthbig" value="{$array[0].phone_no}"></td>
                  </tr>
          ...
          <tr>
			...
			<img src="images/inn_shadowtop.gif" width="1" height="9" /></td>
          </tr>
        </table>