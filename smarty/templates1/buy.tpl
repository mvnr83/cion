...
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="grstr1left">
          ...
          <tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" background="images/field_bg.gif" class="graystr4">
                <tr>
                  <td height="40" colspan="3" align="center" valign="middle" class="blue">Product Registration </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td colspan="3" align="right" valign="top" class="ver11"><img src="images/7pix.gif" width="1" height="7"></td>
                                  ...
                                  <tr>
                    <td align="right" valign="middle"  class="ver11">Request a Quote  : </td>
                    <td align="left" valign="middle" colspan="2">&nbsp;</td>
                  </tr>
                  <tr>
                    <td colspan="3" align="center" valign="middle" class="hea">Questions that are marked with an <span class="verbold">Asterisk (</span><span class="red">*</span><span class="verbold">)</span> must be answered for us to process your request.</td>
                  </tr>
                  <tr>
...
-->                <tr>
                  <td height="35" colspan="3" align="center" valign="middle"><input type="submit" name="Submit" value="Continue to Pay" />
                    &nbsp;</td>
                </tr>
                <tr>
