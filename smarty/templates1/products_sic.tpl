...
function showtrial(id,uname,pname)
{
	...
	else if(uname != '')
	{
		...
		document.form1.action="products_sic.php";
		document.form1.submit();
	}
}
</script>
          ...
          <tr>
            <td height="29" colspan="3" align="center" valign="middle"><table width="98%" height="29" border="0" align="left" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td align="center" valign="middle" bgcolor="#E9E9E9" class="ver11blnormal"><a href="products_sic.php" class="black">System Information &amp; Comparison </a></td>
                  <td align="center" valign="middle" class="black1">|</td>
                ...
                <tr>
                  ...
                  <td align="center" valign="middle"><table width="50%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td align="center" valign="middle"><a href="buy.php?pid={$array[0].id}"><img src="images/buynow.gif" width="97" height="27" border="0"></a></td>
