...
{/literal}<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="grstr1left">
          <tr>
            <td colspan="3" align="left" valign="top"><table width="100%" height="32" border="0" align="left" cellpadding="0" cellspacing="0" background="images/inner_headingbg.gif" class="whitestr">
                ...
                <tr>
                  <td width="2%">&nbsp;</td>
                  <td width="98%" align="left" valign="middle" class="hea">Registration</td><br />
                </tr>
            </table></td>
          </tr>
          <tr>
		 ...
		 <input type="hidden" name="act">
                ...
                -->
                  <tr>
                    <td width="38%" align="right" valign="middle" class="hea">Personal Information : </td>
                    <td width="62%" align="left" valign="middle">&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="ver11"><span class="red">*</span>Email Address:</td>
                    <td align="left" valign="middle"><input name="email" type="text" class="fieldwidthbig"></td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="ver11"><span class="red">*</span>First Name:</td>
                    <td align="left" valign="middle"><input name="fname" type="text" class="fieldwidthbig">
                      <a href="#" class="ari">We value your privacy</a></td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="ver11"><span class="red">*</span>Last Name:</td>
                    <td align="left" valign="middle"><input name="lname" type="text" class="fieldwidthbig"></td>
                  </tr>
				  <tr>
                    <td align="right" valign="middle" class="ver11"><span class="red">*</span>User Name:</td>
                    <td align="left" valign="middle"><input name="uname" type="text" class="fieldwidthbig">
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="ver11"><span class="red">*</span>Password:</td>
                    <td align="left" valign="middle"><input name="pwd" type="password" class="fieldwidthbig"></td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="ver11"><span class="red">*</span>Country:</td>
                    <td align="left" valign="middle"><select name="country" class="ari">
                  ...
                  <tr>
                    <td align="right" valign="middle" class="hea">Company Information </td>
                    <td align="left" valign="middle">&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="ver11"><span class="red">*</span> Company : </td>
                    <td align="left" valign="middle"><input name="company" type="text" class="fieldwidthbig"></td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="ver11"><span class="red">*</span> Job Title : </td>
                    <td align="left" valign="middle"><select name="jtitle" class="ari">
                        <option  value="">---Select---</option>
                  ...
                  <tr>
                    <td align="right" valign="middle" class="ver11"><span class="red">*</span> Industry : </td>
                  ...
                  <tr>
                    <td align="right" valign="middle" class="ver11"><span class="red">*</span> Address 1 : </td>
                    <td align="left" valign="middle"><input name="address1" type="text" class="fieldwidthbig"></td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="ver11">Address 2 :</td>
                    <td align="left" valign="middle"><input name="address2" type="text" class="fieldwidthbig"></td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="ver11"><span class="red">*</span> City : </td>
                    <td align="left" valign="middle"><input name="city" type="text" class="fieldwidthbig"></td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="ver11">County/State/Province/Territory: </td>
                    <td align="left" valign="middle"><input name="state" type="text" class="fieldwidthbig"></td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="ver11">Postal Code:</td>
                    <td align="left" valign="middle"><input name="pcode" type="text" maxlength="10"></td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="ver11"><span class="red">*</span> Phone:</td>
                    <td align="left" valign="middle"><input name="phone" type="text" class="fieldwidthbig"></td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle">&nbsp;</td>
                    <td align="left" valign="middle"><input type="submit" name="submit" value="submit" onClick="javascript:validation();"> 
					</td>
					</tr>
                </table>
                            </form>
