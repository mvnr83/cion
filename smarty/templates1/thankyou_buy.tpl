...
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="grstr1left">
          ...
          <tr>
            <td align="center" valign="top" class="black" colspan="3">Thank you for your interest in CionSystems {$pname}. Our Administrator will contact you soon through mail ..   
