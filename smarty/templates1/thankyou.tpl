...
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="grstr1left">
          <tr>
            <td colspan="3" align="left" valign="top"><table width="100%" height="32" border="0" align="left" cellpadding="0" cellspacing="0" background="images/inner_headingbg.gif" class="whitestr">
                ...
                <tr>
                  <td width="2%">&nbsp;</td>
                  <td width="98%" align="left" valign="middle" class="hea">Thank you</td>
                  <br />
                </tr>
            </table></td>
          </tr>
          ...
          <tr>
            <td align="center" valign="top" class="black" colspan="3">Thank you for your interest in CionSystems {$pname}. An email has been sent to your email address with instructions on how to download the application.   
