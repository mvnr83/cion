            ...
            <td><table width="100%" border="0" cellspacing="3" cellpadding="0">
                ...
                <tr>
                  ...
                  <td width="25%" align="center" valign="top"><a href="buyitnow.php"><img src="images/requesta_quote.gif" width="175" height="37" border="0" /></a> <br />
                    ...
                    <a href="../datasheet/ADM_Datasheet.pdf"><img src="images/downdata.gif" width="175" height="37" border="0" /></a> {if $session_username != ""} <a href="download.php?id=11"><img src="images/download_trail_pro.gif" width="175" height="37" border="0" /></a> {else} <a href="javascript:void(0);" onclick="javascript:return login('{$product_id}','{$pname}');"><img src="images/download_trail_pro.gif" width="175" height="37" border="0" /></a> 
                    {/if} 
                    <!--                   <br />
                   <a href="buyitnow.php"><img src="images/requesta_quote.gif" width="175" height="37" border="0" /></a>--> 
                	...
                	{/if}
                	{/section}-->
                     <a href="../datasheet/admpro_newfeatures_2014.pdf"><img src="images/newfeatures.gif" width="175" height="37" border="0" /></a> 
    				</td>
                </tr>
                <tr>
                  <td colspan="2">&nbsp;</td>
                ...
                <tr>
                  <td align="center" class="olink"><object width="480" height="385">
                      <param name="movie" value="http://www.youtube.com/v/RYW3WTDml6U?fs=1&rel=0&modestbranding=1&enablejsapi=1&amp;hl=en_US">
                      </param>
                      <param name="allowFullScreen" value="true">
                      </param>
                      <param name="allowscriptaccess" value="always">
                      </param>
                      <embed src="http://www.youtube.com/v/RYW3WTDml6U?fs=1&rel=0&modestbranding=1&enablejsapi=1&amp;hl=en_US" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="480" height="385"></embed>
                    </object>
                    &nbsp;&nbsp; <a href="http://www.youtube.com/watch?v=RYW3WTDml6U" target="_blank">&raquo; More viedos</a></td>
                  <td width="25%" align="center" valign="middle"><img src="images/ad_managerpro.jpg" alt="ActiveDirectoryManager" width="154" height="193" title="Active Directory Manager"/></td>
                </tr>
                <tr>
                  <td colspan="2">&nbsp;</td>
                </tr>
                            ...
                            <tr>
                              <td width="42%" align="left" valign="top"><div class="head-list hrline">
                                  ...
                                  <ul type="square">
                                    ...
                                    <li>Easy compliance and governance - who, when, what, where</li>
                                    <li>Easy Permission management and determination</li>
                                    <li>Central management for on premise Active Directory and Office 365</li>
                                  </ul>
                                </div></td>
                              <td width="32%" align="left" valign="top"><div class="head-list hrline">
                                  ...
                                  <ul type="square">
                                    ...
                                    <li id="popup"><a href="workflow.php">Workflow Support</a></li>
                                    <li id="popup"><a href="roborequest.php">Robo Request</a></li>
                                    <li id="popup"><a href="user_design.php">Secure provisioning and deprovisioning</a></li>
                                    <li id="popup"><a href="delegation_design.php">Role Based Access</li>
                                    </a>
                                    ...
                                    <li id="popup"><a href="workflow.php">Change Approval process</a></li>
                                    <li>Office 365 Management</li>
                                    <li>Exchange (2007/2010/2013) Management Through Powershell</li>
                                    <li>AD Management Through Powershell</li>
                                    <li>Manage Local Computer User accounts</li>
                                    <li>Managed Based Service Accounts</li>
                                    <li>Audit trail - who, when, what, where</li>
                                    <li>Easy permission determination</li>
                                    <li>Bulk Modifications management</li>
                                    <li>Temporary User and Temporary Group and Group membership management<span class="pro-list"> </span></li>
                                    <li>Schedule object addition and removal- automated cleanup</li>
                                    <li>Delete Object Archival and Restore</li>
                                    <li id="popup">Granular password, <a href="acl_design.php">ACL management</a></li>
                                    <li id="popup"><a href="gpo_design">Group Policy Object (GPO) management</a></li>
                                    <li id="popup"><a href="ou_delegation.php">OU Delegation</a></li>
                                    <li>Computer, Group, Contact, Site, Schema, Replication, Password management</li>
                      ...
                      <li>Password Management</li>-->
                        ...
                        <td width="25%" valign="top"><div class="system">
                            ...
                            <ul class="list">
                              ...
                              <li>GPMC</li>
                              <li>SQL Server Express 2005 (or higher)</li>
                              <li>Compatible Browser: Internet Explorer 9.0 (or higher), Chrome, Firefox</li>
                            </ul>
                          </div></td>
                      </tr>
                    </table></td>
