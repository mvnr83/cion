...
<!--                    <input type="image" onclick="javascript:showtrial('{$array[cust].id}','{$session_username}','{$array[cust].product_code}');" src="images/tryitnow.gif" alt="Try It Now"  border="0" />--><a href="datasheet/claim_new.pdf" target="_blank"><img src="images/downdata.gif" width="175" height="37" border="0" /></a><br />
                   {if $session_username != ""}
                   <a href="#1"><img src="images/download_trail.gif" width="175" height="37" border="0" /></a>
                   {else}
                   <a href="javascript:void(0);" ><img src="images/download_trail.gif" width="175" height="37" border="0" /></a>
                   {/if}
                   <br />
<!--                   
                   {if $session_username != ""}
                   ...
                   {/if}
                   <br />-->
                  <a href="datasheet/Weighted_Claims_final.pdf" target="_blank"><img src="images/whitepaper.gif" width="175" height="37" border="0" /></a>
                   <br />
    ...
    {/section}    
			...
			<ul id="photos">
				<li><a href="#1"><img src="images/SlideImages/espm/espm1.png" alt="Caption 1" width="620" height="270" /></a></li>
				<li><a href="#2"><img src="images/SlideImages/espm/espm2.png" alt="Caption 2" width="620" height="270" /></a></li>
				<li><a href="#3"><img src="images/SlideImages/espm/espm3.png" alt="Caption 3" width="620" height="270" /></a></li>
				<li><a href="#4" onclick="#play-pause.click();"><iframe title="YouTube video player" width="620" height="270" src="http://www.youtube.com/embed/L37p8HiLMbI?rel=0&modestbranding=1" frameborder="0" allowfullscreen="allowfullscreen"></iframe><!--<img src="" alt="Caption 4" width="620" height="270" />--></a></li>
			...
			<div id="hover-box">
				...
				<ul>
					<li><a href="#1" class="highlight"><img src="images/SlideImages/espm/espm1-thumb.png" alt="Caption 1" width="140" height="41" /><span></span></a></li>
					<li><a href="#2"><img src="images/SlideImages/espm/espm2-thumb.png" alt="Caption 2" width="140" height="41" /></a></li>
					<li><a href="#3"><img src="images/SlideImages/espm/espm3-thumb.png" alt="Caption 3" width="140" height="41" /></a></li>
				...
				<!--<p id="long-desc">Phillies ace Roy Halladay made history in Miami on Saturday, tossing the 20th perfect game in MLB history vs. the Marlins in a 1-0 win. It was the first no-hitter of Halladay's brilliant career.</p>-->
                            ...
                            <tr>
                                <td valign="top">
                                    ...
                                    <p>
                                        CionSystem&rsquo;s Enterprise Security and Policy Manager include the components needed
                                        to harness Claims Based Access Control in Windows Server 2012 and Microsoft SharePoint.
                                        Enterprise Security and Policy Manager ensures that the right people have the right
                                        access to the right information. Using dynamic claims, as opposed to relying on
                                        group membership, means that access is adjusted in real time. Enterprise Security
                                        and Policy Manager supports defining policies via intuitive interfaces. A comprehensive
                                        audit trail, tracking permission changes, is also generated. Creating policies replaces
                                        provisioning and de-provisioning groups to manage access permissions. Define the
                                        policy once, instead of maintaining groups forever.</p>
                                </td>
                                    ...
                                    <table width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td width="75%" align="justify">
                                                <p>Access control based on trusted user and managed devices attributes (claims) such
                                        ...
                                        <tr>
                                            ...
                                            <td align="justify">
                                                <p>Powerful, easy and flexible expression-based access policies based on the classification
                                        ...
                                        <tr>
                                            ...
                                            <td align="justify">
                                                <p>Goes beyond basic permission management via ACL&rsquo;s and security groups. Makes Dynamic
                                                groups simple and on demand and allows for expression based dynamic access groups.
                                                Simplifies granting and denying access to individuals Even though the security group
                                                may itself have access.</p>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="justify">
                                                <p>Automatic and instantaneous when a user&rsquo;s status changes, such as employee role
                                                change, location change, department change, resignations or terminations.</p>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="justify">
                                                <p>Policies are enforced for any method of access of files and SharePoint documents
                                        ...
                                        <tr>
                                            ...
                                            <td align="justify">
                                                <p>Provides powerful central administration options for both SharePoint and Fileshares.</p>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="justify">
                                                <p>Audit trail and easy reports for who, what, when and why</p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
