  ...
  <tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
	 ...
	 <tr>
      <td align="center">
      <div style="width:400px">
      <div style="margin:5px;float:left"><img src="images/32bittrial.gif" onclick="return redirect('http://www.cionsystems.com/trial/ADRecovery_Trial.zip');" onmouseover="this.src='images/32bittrial_hover.gif'" onmouseout="this.src='images/trialdownload_o.gif'" border="0" style="cursor:pointer;" /></div>
     <div style="margin:5px;float:right">
      <img src="images/64bittrial.gif" onclick="return redirect('http://www.cionsystems.com/trial/ADRecovery_x64trial.zip');" onmouseover="this.src='images/64bittrial_hover.gif'" onmouseout="this.src='images/64bittrial.gif'" border="0" style="cursor:pointer;" />
      </div>
      </div>
      </td>
      </tr>
      ...
      <td align="center">
      <div style="width:400px">
      <div style="margin:5px;float:left"><img src="images/32bittrial.gif" onclick="return redirect('http://www.cionsystems.com/trial/ADNotifier_32bit_trial.zip');" onmouseover="this.src='images/32bittrial_hover.gif'" onmouseout="this.src='images/trialdownload_o.gif'" border="0" style="cursor:pointer;" /></div>
     <div style="margin:5px;float:right">
      <img src="images/64bittrial.gif" onclick="return redirect('http://www.cionsystems.com/trial/ADNotifier_64bit_trial.zip');" onmouseover="this.src='images/64bittrial_hover.gif'" onmouseout="this.src='images/64bittrial.gif'" border="0" style="cursor:pointer;" />
      </div>
      </div>
      </td>
      </tr>
      ...
      <td align="center">
      <div style="width:400px">
      <div style="margin:5px;float:left"><img src="images/32bittrial.gif" onclick="return redirect('http://www.cionsystems.com/trial/SystemInfo_32bit_trial.zip');" onmouseover="this.src='images/32bittrial_hover.gif'" onmouseout="this.src='images/trialdownload_o.gif'" border="0" style="cursor:pointer;" /></div>
     <div style="margin:5px;float:right">
