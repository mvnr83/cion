...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
     ...
     <img src="images/64_mirror_bittrial.gif" onclick="return redirect('http://www.trestlebridgegroup.com/cionsystems/ADMPro_64bit_Trial.zip');" onmouseover="this.src='images/64_mirrorbittrial_hover.gif'" onmouseout="this.src='images/64_mirror_bittrial.gif'" border="0" style="cursor:pointer;" />
      </div>-->
	 ...
	 <tr>
      ...
      <div style="width:400px">
      <!-- <div style="margin:5px;float:left">
      <img src="images/64_mirror_bittrial.gif" onclick="return redirect('http://www.trestlebridgegroup.com/cionsystems/ADRecovery_64bit_trial.zip');" onmouseover="this.src='images/64_mirrorbittrial_hover.gif'" onmouseout="this.src='images/64_mirror_bittrial.gif'" border="0" style="cursor:pointer;" /></div> -->
     <div style="margin:5px;float:center">
      ...
      <img src="images/64_mirror_bittrial.gif" onclick="return redirect('http://www.trestlebridgegroup.com/cionsystems/ADCN_ADReporter_64bit_Trial.zip');" onmouseover="this.src='images/64_mirrorbittrial_hover.gif'" onmouseout="this.src='images/64_mirror_bittrial.gif'" border="0" style="cursor:pointer;" />
     ...
     <div style="margin:5px;float:center">
      ...
      <img src="images/64_mirror_bittrial.gif" onclick="return redirect('http://www.trestlebridgegroup.com/cionsystems/CMT_64bit_trial.zip');" onmouseover="this.src='images/64_mirrorbittrial_hover.gif'" onmouseout="this.src='images/64_mirror_bittrial.gif'" border="0" style="cursor:pointer;" />
     ...
     <div style="margin:5px;float:center">
      ...
      <img src="images/64_mirror_bittrial.gif" onclick="return redirect('http://www.trestlebridgegroup.com/cionsystems/AD_Office365_Self_64bit_trial.zip');" onmouseover="this.src='images/64_mirrorbittrial_hover.gif'" onmouseout="this.src='images/64_mirror_bittrial.gif'" border="0" style="cursor:pointer;" />
     ...
     <div style="margin:5px;float:center">
      ...
      <td align="center">
      <div style="width:400px">
       <!--<div style="margin:5px;float:left"><img src="images/64_mirror_bittrial.gif" onclick="return redirect('http://www.trestlebridgegroup.com/cionsystems/SystemInfo_32bit_trial.zip');" onmouseover="this.src='images/64_mirrorbittrial_hover.gif'" onmouseout="this.src='images/64_mirror_bittrial.gif'" border="0" style="cursor:pointer;" /></div>-->
     <div style="margin:5px;float:center">
      ...
      <td align="center">
      <div style="width:400px">
       <!--<div style="margin:5px;float:left"><img src="images/64_mirror_bittrial.gif" onclick="return redirect('http://www.trestlebridgegroup.com/cionsystems/GPOManager_64bit.zip');" onmouseover="this.src='images/64_mirrorbittrial_hover.gif'" onmouseout="this.src='images/64_mirror_bittrial.gif'" border="0" style="cursor:pointer;" /></div>-->
     <div style="margin:5px;float:center">
      ...
      {elseif $row[list].product_code == 'tfa'}
      <tr>
      <td align="center">
      <div style="width:400px">
       <!--<div style="margin:5px;float:left"><img src="images/64_mirror_bittrial.gif" onclick="return redirect('http://www.trestlebridgegroup.com/cionsystems/Self_service_64bit_trial.zip');" onmouseover="this.src='images/64_mirrorbittrial_hover.gif'" onmouseout="this.src='images/64_mirror_bittrial.gif'" border="0" style="cursor:pointer;" /></div>-->
      <div style="margin:5px;float:center">
      <img src="images/64bittrial.gif" onclick="return redirect('http://www.cionsystems.com/trial/Self_service_64bit_trial.zip');" onmouseover="this.src='images/64bittrial_hover.gif'" onmouseout="this.src='images/64bittrial.gif'" border="0" style="cursor:pointer;" />
      </div>
      </div>
      </td>
      </tr>
