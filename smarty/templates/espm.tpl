...
<!--                    <input type="image" onclick="javascript:showtrial('{$array[cust].id}','{$session_username}','{$array[cust].product_code}');" src="images/tryitnow.gif" alt="Try It Now"  border="0" />--><a href="datasheet/claim_new.pdf" target="_blank"><img src="images/downdata.gif" width="175" height="37" border="0" /></a><br />
                   {if $session_username != ""}
                   <a href="http://www.cionsystems.com/registerbeta.php"><img src="images/download_beta.png" width="175" height="37" border="0" /></a>
                   {else}
                   <a href="http://www.cionsystems.com/registerbeta.php" ><img src="images/download_beta.png" width="175" height="37" border="0" /></a>
                   {/if}
                   <br />
<!--                   
    ...
    {/section}    
			...
			<ul id="photos">
				...
				<li><a href="#4" onclick="#play-pause.click();"><iframe id="player" title="YouTube video player" width="620" height="270" src="http://www.youtube.com/embed/L37p8HiLMbI?rel=0&modestbranding=1&enablejsapi=1" frameborder="0" allowfullscreen="allowfullscreen"></iframe><!--<img src="" alt="Caption 4" width="620" height="270" />--></a></li>
