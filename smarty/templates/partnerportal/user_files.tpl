...
<table width="100%" border="0" cellspacing="5" cellpadding="0">
  <tr>
    <td height="30" align="center"><strong>File Uploaded to User</strong></td>
  </tr>
  <tr>
    <td align="center">
  ...
  <tr bgcolor='{cycle values="#f1f1f1, #f7f7f7"}'>
    ...
    <td align="center" class="grid"><a href="download.php?filename={$array[list].Ufiles}">Download</a></td>
    <td align="center" class="grid">{$array[list].filetype}</td>
    <td align="center" class="grid">{$array[list].Udate|date_format:"%d-%m-%Y"}</td>
    <td align="center" class="grid">{if $array[list].Ustatus == 'Active'}<img src="../partnerportal/images/active.gif">
    {else}
