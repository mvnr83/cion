...
<table width="100%" height="80%" border="0" align="center" cellpadding="0" cellspacing="4">
  ...
  <tr>
    ...
    <td align="left" valign="middle"><input type="file" name="logo" class="txtfield" /></td>
  </tr>
  <tr>
    <td align="right" valign="middle"> <span class="error">*</span> Company Url :</td>
    <td align="left" valign="middle"><input name="companyurl" type="text" class="txtfield" /></td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="right" valign="middle"><span class="error">*</span> Address 2 :</td>
  ...
  <tr>
    ...
    <td align="left" valign="middle">
      <input type="image" name="submit" value="submit" id="imageField" src="images/submitbtn.gif" onclick="return check_it();"  /></td>
  </tr>
</table>
</form>
</div>
...
//You should create the validator only after the definition of the HTML form
  ...
  frmvalidator.addValidation("address2","alnumhyphen_s","Please enter your Address");
  ...
  frmvalidator.addValidation("phone","req","Please enter your Phone Number");
   ...
   frmvalidator.addValidation("security_code", "alpha_s", "Please enter captcha");
