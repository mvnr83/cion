    ...
    <tr>
      ...
      <td width="96%"><table width="100%" border="0" cellspacing="3" cellpadding="0">
          ...
          <tr>
            ...
            <div class="googleapp"><h1>Reporter for Active Directory</h1></div>
            <h2 class="navigation_protitle"><a href="index.php" style="text-decoration:none;" title="Home">Home</a> <span style="font-size:17px; color:#999999;">&raquo;</span> <a href="active-directory-tools.php" style="text-decoration:none; " title="Products">Products</a> <span style="font-size:17px; color:#999999;">&raquo;</span> <span>Active Directory</span> Reporter</h2></td>
...
<a href="scheduleademo.php?product=ActiveDirectoryReporter"><img src="images/sademo.gif" width="175" height="37" border="0" /></a>  --> {/if} 
            ...
            <br />  --> 
              ...
              <a href="../datasheet/ADR_Datasheet.pdf"><img src="images/downdata.gif" width="175" height="37" border="0" /></a> {/if}

              {/section} 

              

               <a href="../datasheet/adr_newfeatures_2014.pdf"><img src="images/newfeatures.gif" width="175" height="37" border="0" /></a> 
          ...
          <tr>
            ...
            <td align="center"><object width="480" height="385">
                ...
                <param name="movie" value="http://www.youtube.com/v/a5n5T0oKimQ&hl=en_US?fs=1&rel=0&modestbranding=1&enablejsapi=1">
                ...
                <embed src="http://www.youtube.com/v/a5n5T0oKimQ&hl=en_US?fs=1&rel=0&modestbranding=1&enablejsapi=1" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="490" height="275"></embed>
              ...
              <div class="box" style="border:2px solid #CCCCCC;width:550px;">
                ...
                <table width="100%" border="0" cellspacing="3" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td align="left" width="50%" valign="top" class="hrline"><div id="list" >
