  ...
  <tr>
    ...
    <table width="100%" height="124" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="61%" align="left" valign="bottom"><div class="logged">Logged In as:&nbsp;{$partner[0].first_name}</div></td>
        <td width="5%">&nbsp;</td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td height="73%" valign="top" align="center"><table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
