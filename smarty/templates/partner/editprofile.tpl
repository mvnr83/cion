...
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="20" colspan="2" align="center" valign="middle" class="black">Fields marked with<span class="red"> * </span>are required.</td>
          </tr>
          <tr>
		 ...
		 <table width="80%" border="0" cellspacing="4" cellpadding="0" style="border:1px solid #CCCCCC;">
<tr>
                  ...
                  <tr>
                    ...
                    <td align="left" valign="middle"><input name="company" type="text" class="fieldwidthbig con" value="{$array[0].company}" /></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td align="left" valign="middle"><select name="industry" class="ari sel">
                        <option  value="">---Select---</option>
                  ...
                  <tr>
                    ...
                    <td align="left" valign="middle"><input name="uname" type="text" class="fieldwidthbig con" value="{$array[0].user_name}" readonly="true" />                    </td>
                    <td align="right" valign="middle" class="ver11" nowrap="nowrap"><span class="red">*</span> Address 1 : </td>
                    <td align="left" valign="middle"><input name="address1" type="text" class="fieldwidthbig con" value="{$array[0].address1}" /></td>
                  </tr>
                  <tr>
                    ...
                    <td align="left" valign="middle"><input name="address2" type="text" class="fieldwidthbig con" value="{$array[0].address2}" /></td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="ver11"><span class="red">*</span>Country:</td>
                    <td align="left" valign="middle"><select name="country" class="ari sel" style="width:220px">
                        <option  value="">---Select---</option>
                    ...
                    <td align="left" valign="middle"><input name="city" type="text" class="fieldwidthbig con" value="{$array[0].city}" /></td>
                  </tr>
                  <tr>
                    ...
                    <td align="left" valign="middle"><input name="state" type="text" class="fieldwidthbig con" value="{$array[0].state}" /></td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="ver11">&nbsp;</td>
                    <td align="left" valign="middle">&nbsp;</td>
                    <td align="right" valign="middle" class="ver11">Postal Code:</td>
                    <td align="left" valign="middle"><input name="pcode" type="text" class="fieldwidthbig con" maxlength="10" value="{$array[0].zipcode}" /></td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="ver11">&nbsp;</td>
                    <td align="left" valign="middle">&nbsp;</td>
                    <td align="right" valign="middle" class="ver11"><span class="red">*</span> Phone:</td>
                    <td align="left" valign="middle"><input name="phone" type="text"  class="fieldwidthbig con" value="{$array[0].phone_no}" /></td>
                  </tr>
                  <tr>
                    <td colspan="2" rowspan="2" align="center" valign="middle" class="ver11">
                    <img src="{if $partner[0].company_logo == ""}
        images/company_logo/default_logo.jpg
        {else}
        {$partner[0].company_logo}
        {/if}
        "  border="0" alt="{$partner[0].company}" />
                    
                    </td>
                    <td height="30" align="right" valign="middle" class="ver11">Company Url :</td>
                    <td height="30" align="left" valign="middle" class="ver11"><input name="url" type="text"  class="fieldwidthbig con" value="{$array[0].company_url}" /></td>
                  </tr>
                  <tr>
                    <td height="30" align="right" valign="middle" class="ver11">&nbsp;</td>
                    <td height="30" align="left" valign="middle" class="ver11">&nbsp;</td>
                  </tr>
                  <tr>
                    <td height="30" colspan="4" align="center" valign="middle" class="ver11"><input type="submit" name="submit2" value="submit" /></td>
                  </tr>
                </table>
            </form></td>
          </tr>
