  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td colspan="2" align="center" valign="middle" class="toplinks"><!--<a href="buyitnow.php" style="font-size:11px; color:#FF0000; font-weight:bold;" title="Request A Quote">Request A Quote</a>--><a href="buyitnow.php" style="font-size:11px; color:#FF0000; font-weight:bold;" title="Request A Quote">Request A Quote</a> | 
...
<!--</span> {literal} <script type="text/javascript" src="http://cdn.socialtwist.com/2010031436976/script.js"></script><a class="st-taf" href="http://tellafriend.socialtwist.com:80" onclick="return false;" style="border:0;padding:0;margin:0;"><img alt="SocialTwist Tell-a-Friend" style="border:0;padding:0;margin:0;" src="http://images.socialtwist.com/2010031436976/button.png"onmouseout="STTAFFUNC.hideHoverMap(this)" onmouseover="STTAFFUNC.showHoverMap(this, '2010031436976', window.location, document.title)" onclick="STTAFFUNC.cw(this, {id:'2010031436976', link: window.location, title: document.title });"/></a>{/literal}-->
          ...
          <tr>
            ...
            <table width="250" border="0" align="right" cellpadding="0" cellspacing="0" bgcolor="#cccccc">
              <tr>
                ...
                <a href="myaccount.php" title="My Account"><img src="images/myaccountbtn.gif" width="95" height="19" alt="My Account" title="My Account" /></a>   &nbsp; <a href="logout.php" title="Logout"><img src="images/logoutbtn.gif" width="77" height="19" alt="Logout" title="Logout" /></a> 
                {/if}
                </td>
