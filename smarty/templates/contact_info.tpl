...
<tr>
            ...
            <td colspan="2" align="center" valign="middle" nowrap="nowrap" bgcolor="#f2f2f2" ><strong>Company Information</strong> </td>
                  ...
                  <tr>
                    ...
                    <td align="left" valign="middle"><input name="company" type="text" class="txtfield" value="{$array[0].company}" /></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td align="left" valign="middle"><input name="uname" type="text" class="txtfield" value="{$array[0].user_name}" readonly="true" />                    </td>
