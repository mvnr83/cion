          ...
          <tr>
            ...
            <td><table width="100%" border="0" cellspacing="3" cellpadding="0">
                ...
                <tr>
                  ...
                  <td valign="top" align="left"><table border="1" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse; border:solid 1px #ccc">
                      ...
                      <tr>
                        ...
                        <td width="50%" valign="top"><p> &quot;Supports Microsoft Azure AD, Office 365, Microsoft AD, Red Hat Open LDAP, and Centos Open LDAP&quot;</p>
                          ...
                          <ul class="list">
                            ...
                            <li> Track all password activity to support full auditing and reporting
                        ...
                        <td valign="top"><p> CionSystems&#39; Cloud Identity Minder is a state-of-the-art solution for identity administration
                          ...
                          <ul class="list">
                           ...
                           User self-signup, self-registration and self-service
                            ...
                            <li>
                             ...
                             Cloud Identity Minder for Password and account unlock
                ...
                <tr>
                  ...
                  <td colspan="2" class="head-list"><h3> Cloud Identity Minder can also send alerts such as :</h3>
