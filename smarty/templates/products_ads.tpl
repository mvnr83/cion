                                            ...
                                            <td width="75%" align="left" valign="top">
                                                <div class="head-list hrline">
                                                    ...
                                                    <ul type="square">
                                                        ...
                                                        <li>Automatic Password Expiry Notification for Office 365
                                                            and BPOS Users</li>
                                                        <li>Multi-factor authentication. Supports one time password&nbsp;
                                                            Authentication for changing, resetting passwords and Unlocking Account</li>
                                                        <li>Automatically resetting password expired Users password
                                                            automatically</li>
                                                        <li>Automated notifications of Password audit report, Mail
                                                            status Report, Unlock audit </li>
                                                        <li>Automatic notification to user when password is changed
                                                            or reset</li>
                                                    </ul>
                                                </div>
