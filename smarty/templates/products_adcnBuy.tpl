...
<!--                  <a href="buyitnow.php"><img src="images/requesta_quote.gif" width="175" height="37" border="0" /></a>
      ...
      <tr>
        ...
        <td width="25%" align="center" valign="middle"><img src="images/ad_change.jpg"  alt="Active Directory Change Notifier" width="154" height="193" title="Active Directory Change Notifier" /></td>
      </tr>
      <tr>
        <td colspan="2" align="left"><p>Unmanaged  changes are a problem in every company. They are THE primary cause of outages.  If they are not prevented, the company will fail a security audit. However,  even planned changes should be monitored to ensure that policies are being  followed.</p>
