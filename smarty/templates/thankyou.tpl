...
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="grstr1left">
          ...
          <tr>
            ...
            <td colspan="3" align="left" valign="top"><table width="100%" height="32" border="0" align="left" cellpadding="0" cellspacing="0" background="images/inner_headingbg.gif" class="whitestr">
                ...
                <tr>
                  ...
                  <td width="98%" align="left" valign="middle"><h2 class="protitle"><span>Thank</span> you</h2></td>
          ...
          <tr>
            ...
            <td align="center" valign="top" class="ver11" colspan="3"><strong>Thank you for your interest in CionSystems {$pname}.<br />
 An email has been sent to your email address with instructions on how to download the application.</strong></td>
          </tr>
