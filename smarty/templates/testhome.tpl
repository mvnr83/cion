...
<table width="900" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="85" valign="bottom"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="79" style="padding-left: 20px"><a href="http://www.cionsystems.com" title="Cion Systems"> <img src="images/logo.gif" width="220" height="50" border="0" alt="Cion Systems"
                                    title="Cion Systems"></a></td>
          <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td colspan="2" align="center" valign="middle" class="toplinks"><!--<a href="buyitnow.php" style="font-size:11px; color:#FF0000; font-weight:bold;" title="Request A Quote">Request A Quote</a>--> 
                  <a href="buyitnow.php" style="font-size: 11px; color: #FF0000; font-weight: bold;"
                                            title="Request A Quote">Request A Quote</a> | <a href="mailto:support@cionsystems.com"> support@cionsystems.com</a><a href="javascript:void(0)" onclick="document.getElementById('light').style.display='block';document.getElementById('fade').style.display='block'"
                                                    title="Signup for the Quarterly Newsletter"></a></td>
              </tr>
              <tr>
                <td height="25" colspan="2" align="center"><!--<table border="0" cellspacing="0" cellpadding="0">              <tr>                <td width="70"><img src="images/search.gif" alt="SEARCH" width="55" height="12" /></td>                <td  class="searchtxt_bg"><input type="text" name="textfield" class="searchtxt" id="textfield" /></td>                <td align="left" style="padding-bottom:1px;"><input type="image" name="imageField" id="imageField" src="images/searchbtn.gif" /></td>              </tr>            </table>--> 
                  <span style="padding-right: 20px; font-family: Verdana, Arial, Helvetica, sans-serif"> 
                  <script language="JavaScript">				<!-- hide from old browsers				  var curDateTime = new Date()				  document.write(curDateTime.toLocaleString())				//-->			 </script></td>
              </tr>
              <tr>
                <td width="100%" align="right" valign="middle"><!--</span> {literal} <script type="text/javascript" src="http://cdn.socialtwist.com/2010031436976/script.js"></script><a class="st-taf" href="http://tellafriend.socialtwist.com:80" onclick="return false;" style="border:0;padding:0;margin:0;"><img alt="SocialTwist Tell-a-Friend" style="border:0;padding:0;margin:0;" src="http://images.socialtwist.com/2010031436976/button.png"onmouseout="STTAFFUNC.hideHoverMap(this)" onmouseover="STTAFFUNC.showHoverMap(this, '2010031436976', window.location, document.title)" onclick="STTAFFUNC.cw(this, {id:'2010031436976', link: window.location, title: document.title });"/></a>{/literal}--> 
                  <!-- Start SocialFollow.com Button Code --> 
                  <!--<img src="http://www.socialfollow.com/button/image/?b=5130" class="socialFollowImage" alt="Follow Me!" /><script type="text/javascript" src="http://www.socialfollow.com/button/?b=5130"></script><script type="text/javascript">socialfollow.init("socialFollowImage");</script>--> 
                  <!-- End SocialFollow.com Button Code --></td>
                <td width="0%" align="right"><span style="float: right;"> 
              ...
              <ul id="p7menubar">
                ...
                <li><a href="solution_all.php" class="trigger" title="Solutions">Solutions</a>
                  <ul>
					...
					<li><a href="ADProvisioning.php" title="Provisioning Solutions">testing</a></li>
                  </ul>
                </li>
              ...
              <tr>
                <td height="28" align="right" valign="top" class="titlebg"><table width="250" border="0" align="right" cellpadding="0" cellspacing="0" bgcolor="#cccccc">
                    <tr>
                      ...
                      <td width="279" align="center"> {if $session_username == ''}
                        ...
                        {else if $session_username != ''} <a href="myaccount.php" title="My Account"> <img src="images/myaccountbtn.gif" width="95" height="19" alt="My Account" title="My Account" /></a> &nbsp; <a href="logout.php" title="Logout"> <img src="images/logoutbtn.gif" width="77" height="19" alt="Logout" title="Logout" /></a> {/if} </td>
