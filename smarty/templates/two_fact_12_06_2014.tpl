                ...
                <tr>
                    <td>
                        <h2 class="navigation_protitle">
                            ...
                            <span>Authentication</span> and <span>Self Service</span></h2>
                    </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="3" cellpadding="0">
                            ...
                            <tr><td align="center" class="highlite"><h3>Now supporting Microsoft Azure AD and Microsoft Office 365.</h3></td><td></td></tr>
                            <tr>
...
<a href="scheduleademo.php?product=ActiveDirectorySelfService"><img src="images/sademo.gif" width="175" height="37" border="0" /></a> -->
                 ...
                 <input type="image" onclick="javascript:showtrial('{$array[cust].id}','{$session_username}','{$array[cust].product_code}');" src="images/tryitnow.gif" alt="Try It Now"  border="0" />-->
                                   ...
                                   {/if}
                                    {/section}
                                    <a href="../datasheet/Authentication_selfservice_datasheet.pdf">
                                ...
                                <td valign="top" align="left">
                                    <table border="1" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;">
                                        <tr style="background-color:#f0f0f0;">
                                            <td align="center" width="50%" style="line-height:25px;">
                                                <b>Benefits</b>
                                            </td>
                                        ...
                                        <tr>
                                            <td width="50%"><p>
                                                    &quot;Supports Microsoft Azure AD, Office 365, Microsoft AD, Red Hat Open LDAP, and Centos Open LDAP&quot;</p>
                                              <ul class="list">
                                                    <li>
                                                        <p>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td width="75%" align="left" valign="top">
                                                ...
                                                <div align="left" style="width: 700px; padding-top:20px; margin: 0 auto 0 0;">
                                                    <img src="images/two_fact.png" alt="" width="642px" border="0" />
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
