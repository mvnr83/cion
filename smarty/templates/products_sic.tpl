    ...
    <table width="100%" border="0" cellspacing="3" cellpadding="0">
      ...
      <tr>
        <td valign="top"><p>Have  you ever wondered why your Windows system suddenly stopped working? What  changed? Why your application works in development and won&rsquo;t run on production  system or why one of the two identically configured systems is not working?</p>
          ...
          <p>System Information Comparison is an easy-to-use application loaded with powerful features that aid an administrator in making Windows clients, servers and/or set of systems (it can be a cluster) as stable as possible. It supports Windows XP, Windows 2003, and all flavors of Windows Vista, Windows 7, Windows 2008 and Windows 2008 R2..</p></td>
          ...
          <a href="http://www.youtube.com/results?search_query=cionsystems&search_type=&aq=f" target="_blank"><img src="images/videos.gif" height="37" width="175" border="0" /></a>
