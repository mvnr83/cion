                ...
                <tr>
                    <td>
                        <h2 class="navigation_protitle">
                            ...
                            <span>Active Directory Self-Service</span> and <span>Microsoft BPOS | Office 365</span></h2>
                    </td>
                </tr>
                <tr>
                    <td>
                                                ...
                                                <div class="head-list hrline">
                                                    ...
                                                    <ul type="square">
                                                        ...
                                                        <li>Self service for password resets (portal for users to reset and unlock without having
                                                            to call IT Helpdesk) for local domain and Microsoft BPOS | Office 365<br />
                                                        </li>
                                                        <li>Passwords are synchronized between local domain and Microsoft BPOS | Office 365
                                                            | AD Domain<br />
                                                        </li>
                                                        ...
                                                        <li><span style="color: black">Automatic Password Expiry Notification for Office 365
                                                            and BPOS Users</span></li>
                                                        <li><span style="color: black">Multi-factor authentication. Supports one time password&nbsp;
                                                            Authentication for changing, resetting passwords and Unlocking Account</span></li>
                                                        <li><span style="color: black">Automatically resetting password expired Users password
                                                            automatically</span></li>
                                                        <li><span style="color: black">Automated notifications of Password audit report, Mail
                                                            status Report, Unlock audit </span></li>
                                                        <li><span style="color: black">Automatic notification to user when password is changed
                                                            or reset</span></li>
                                                    </ul>
                                                </div>
