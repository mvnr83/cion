          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="3" cellpadding="0">
				...
				<tr>
				  ...
				  <p>See CionSystems Multi-Factor authentication in use, securing a Windows login.</p>
				  <p> 
				  <a href="TwoFactorAuth.php" style="color:blue;">Sign up free and multifactor factor solution for Windows Login</a></p>
				  <p>
				  <a href="TwoFactorWin.php" style="color:blue;">See CionSystems Multi-Factor authentication for securing a Windows login in an enterprise and for web applications.</a></p>
				  </td>
				  <td width="25%"></td>
                    </tr>
