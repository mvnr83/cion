...
{$productname}
{else}
<meta name="description" content="Windows Management solutions,System Information and Comparison, Remote Management, Active Directory Management, Asset Managemnet and Auditing ">

<meta name="keywords" content="Cion, systems,cionsystems, windows, management, IT, compare, syscompare,systemcompare, remote, manager, asset, audit,computer, software, license, compliance, active directory, ad, active, directory, system restore, restore, shutdown, wake on lan, install, unnstall, inventory, helpdesk, ticketing, monitoring,  hardware, inventory, recovery, event"> 
...
<table width="900" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="79" style="padding-left:20px"><a href="http://www.cionsystems.com"><img src="../images/logo.gif" width="220" height="50" border="0" /></a></td>
        <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="center" valign="middle" class="toplinks"><a href="buyitnow.php" style="font-size:11px; color:#FF0000; font-weight:bold;" title="Request A Quote">Request A Quote</a> | <a href="mailto:support@cionsystems.com">support@cionsystems.com</a></td>
          </tr>
          <tr>
...
//-->
          ...
          <tr>
            ...
            <table width="250" border="0" align="right" cellpadding="0" cellspacing="0" bgcolor="#cccccc">
              <tr>
                ...
                {if $session_username == ''}
                <div style="float:left"><a href="../register.php">Not a Member ? Signup Here </a></div>
                <div style="float:right"><a href="../login.php"><img src="../images/loginbtn.gif" alt="login" width="75" height="17" border="0" /></a></div>
                {else if $session_username != ''}
               
                <a href="../myaccount.php"><img src="../images/myaccountbtn.gif" width="95" height="19" alt="MyAccount" /></a>   &nbsp; <a href="../logout.php"><img src="../images/logoutbtn.gif" width="77" height="19" alt="Logout" /></a> 
                {/if}
                </td>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="center" valign="middle"><div class="copyright"><dd>Copyright © 2008 CionSystems, Inc. All Rights Reserved.</dd></div></td>
      </tr>
    </table></td>
  </tr>
</table>
