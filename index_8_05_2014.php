...
<table width="900" border="0" cellspacing="0" cellpadding="0">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
   ...
   <tr><td width="35%" height="65" style="padding-left:20px;vertical-align:bottom;"><a href="http://www.cionsystems.com" title="Cion Systems"><img src="images/logo.gif" title="Cion Systems" alt="Cion Systems" width="220" height="50" border="0" style="margin-bottom:8px;" /></a> </td>
    ...
    <td width="65%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
       <td align="right">
  <div style="margin-top:2px;float:right;margin-bottom:2px;vertical-align:middle;">
  <form name="form1" method="post" action="" style="margin:0px; padding:0px;"><?php $name = $_SESSION['username'];?>
  <span style="padding:4px"><strong>Try Any Product for FREE</strong></span>
  <select name="jumpMenu" id="jumpMenu" onChange="return goto_download(this.value,'<?php echo $name;?>')" style="padding:3px; font-size:12px;">
                            ...
                            <option value="<?php echo $total_pro[$i]['id'];?>,<?php echo $total_pro[$i]['product_code'];?>">Two Factor Authentication</option>
      ...
      <tr>
  <td align="right">
  <div align="center" style="background:#FC9B20;margin-top:0px;float:right;height:25px;margin-bottom:2px;vertical-align:middle;border:solid 1px #a57901;border-radius:2px;width:85%;"><a href="http://www.cionsystems.com/Enterprise-Self-Service.php" style="font-weight:bold; font-size:13px; text-decoration:none; color:#000000;position:relative;top:25%;">New Release -  Enterprise self-service for Virtual directories, Azure, Office365</a>
  </div>
  </td>
  </tr>
...
-->
          ...
          <!--              <a href="http://www.cionsystems.com/LiveSupport/client.php?locale=en" target="_blank" onClick="if(navigator.userAgent.toLowerCase().indexOf('opera') != -1 && window.event.preventDefault) window.event.preventDefault();this.newWindow = window.open('http://www.cionsystems.com/LiveSupport/client.php?locale=en&url='+escape(document.location.href)+'&referrer='+escape(document.referrer), 'webim', 'toolbar=0,scrollbars=0,location=0,status=1,menubar=0,width=640,height=480,resizable=1');this.newWindow.focus();this.newWindow.opener=window;return false;">
              ...
              <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #EDEDED;">
                    ...
                    <tr>
                      ...
                      <table width="100%" >
                      <tr>
                      <td width="99%"><h3 class="h3Color">Identity and Access Management and Monitoring :</h3>

                        <div class="list">

                          <ul>

                            <li><a href="active-directory-manager.php"><img src="images/bullet1.gif" alt="ADM Pro" />Identity Administration and Management</a></li>

                            <li><a href="active-directory-recovery.php"><img src="images/bullet1.gif" alt="Backup Restore" />Disaster Protection – Backup and  Recovery</a></li>

                            <li><a href="active-directory-ChangeNotifier.php"><img src="images/bullet1.gif" alt="Notifier" />Real time Change Monitoring and Notification</a></li>
                      ...
                      <td width="99%"><h3 class="h3Color">Infrastructure Management:</h3>
                        ...
                        <div class="list">
                          ...
                          <ul>
                            ...
                            <li><a href="active-directory-reporter.php"><img src="images/bullet1.gif" alt="Reporter" />Reporter</a></li>

                            <li><a href="active-directory-recovery.php"><img src="images/bullet1.gif" alt="Backup Restore" />Backup and Restore</a></li>

                            <li><a href="espm.php"><img src="images/bullet1.gif" alt="Claims" />Enterprise Security Policy Manager</a></li>
                      ...
                      <td width="99%"><h3 class="h3Color">Compliance and Governance:</h3>
                        ...
                        <div class="list">
                          ...
                          <ul>
                            ...
                            <li><a href="active-directory-reporter.php"><img src="images/bullet1.gif" alt="Reporter" />Reporter Compliance Suite</a></li>

                            <li><a href="espm.php"><img src="images/bullet1.gif" alt="Claims" />Enterprise Security Policy Manager</a></li>

                            <li><a href="active-directory-manager.php"><img src="images/bullet1.gif" alt="ADM Pro" />Active Directory Manager Pro</a></li>
                            <li><a href="Enterprise-Self-Service.php"><img src="images/bullet1.gif" alt="Enterprise Self-Service" />Enterprise Self-Service</a></li>
                          </ul>
                ...
                <td><table width="100%" border="0" cellspacing="5" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td width="64%" rowspan="2" align="left" valign="top"><h3>Affordable Identity and Access Lifecycle Management Solutions</h3>
                        ...
                        <p align="justify">Reduce number of administrators and other high privilege accounts.<br />

                          <br /> Your IT budget is stretched thin and you struggle to cut support costs. It doesn't help that manual Identity administration and management, provisioning and de-provisioning processes are time-consuming. Even worse, manual implementation can be error-prone, threatening the security of your environment. <br />
                           ...
                           <tr>
                              ...
                              <td><div id="marqueecontainer" onMouseover="copyspeed=pausespeed" onMouseout="copyspeed=marqueespeed" style="height:180px;">
                                  ...
                                  <div id="vmarquee" style="position: absolute; width: 100%;">                               
                                   ...
                                   <a href="http://cionsystems.com/press/index-15.html" style="text-decoration:none;" onMouseOver="style.fontWeight = 'bold'" onMouseOut="style.fontWeight = 'normal'" title="January 6, 2014: CionSystems Releases Enterprise Self Service Version 4.0">January 6, 2014: CionSystems Releases Enterprise Self Service Version 4.0</a><br />
                                   <br />
<a href="http://cionsystems.com/press/index-14.html" style="text-decoration:none;" onMouseOver="style.fontWeight = 'bold'" onMouseOut="style.fontWeight = 'normal'" title="July 16, 2013: CionSystems Releases Enterprise Self Service Version 3.0">July 16, 2013: CionSystems Releases Enterprise Self Service Version 3.0 </a><br />
     <br />

<a href="http://cionsystems.com/press/index-10.html" style="text-decoration:none;" onMouseOver="style.fontWeight = 'bold'" onMouseOut="style.fontWeight = 'normal'" title="May 26, 2013: CionSystems Releases GPOManager version 3.0 ">May 26, 2013: CionSystems Releases GPOManager version 3.0 </a><br />
     <br />

<a href="http://cionsystems.com/press/index-11.html" style="text-decoration:none;" onMouseOver="style.fontWeight = 'bold'" onMouseOut="style.fontWeight = 'normal'" title="June 10, 2013: CionSystems Releases Active Directory Manager Pro version 4.01">June 10, 2013: CionSystems Releases Active Directory Manager Pro version 4.01</a><br />
     <br />
<a href="http://cionsystems.com/press/index-12.html" style="text-decoration:none;" onMouseOver="style.fontWeight = 'bold'" onMouseOut="style.fontWeight = 'normal'" title="Oct 6, 2012: CionSystems Releases Active Directory Manager Pro version 4.0">Oct 6, 2012: CionSystems Releases Active Directory Manager Pro version 4.0</a><br />
     <br />    
                  
<a href="http://cionsystems.com/press/index-13.html" style="text-decoration:none;" onMouseOver="style.fontWeight = 'bold'" onMouseOut="style.fontWeight = 'normal'" title="April 16, 2012: CionSystems Releases Active Directory Reporter version 4.0">April 16, 2012: CionSystems Releases Active Directory Reporter version 4.0</a><br />
     <br />     
...
<a href="http://cionsystems.com/press/index-9.html" style="text-decoration:none;" onMouseOver="style.fontWeight = 'bold'" onMouseOut="style.fontWeight = 'normal'" title="March 26, 2012: CionSystems Announces the Release of new version of Active Directory Manager PRO 3.0.0.5 ">March 26, 2012: CionSystems Announces the Release of new version of Active Directory Manager PRO 3.0.0.5 </a><br />
                                   ...
                                   <a style="text-decoration:none;" onMouseOver="style.fontWeight = 'bold'" onMouseOut="style.fontWeight = 'normal'" title="March 26, 2012: CionSystems Announces the Release of new version of Enterprise Self-Service | Office 365">March 26, 2012: CionSystems Announces the Release of new version of Enterprise Self-Service | Office 365 </a><br />
