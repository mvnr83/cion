...
$get_product = mysql_fetch_array(mysql_query("select * from product_details where id='16' and status='Active'"));



	$metatitle = 'Google App Sales Force Password Self Service | Enterprise Self Service';



	$metadesc = 'Cion System offers Enterprise Self Service to help the users reset their Google app sales force password without having call to IT helpdesk. Unlock user accounts in a hassle free way.';
...
$content=$smarty->fetch("products_adsz.tpl");
