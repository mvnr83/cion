  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td height="79" style="padding-left:20px"><a href="http://www.cionsystems.com" title="Cion Systems"><img src="images/logo.gif" title="Cion Systems" alt="Cion Systems" width="220" height="50" border="0" /></a>
        ...
        <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td colspan="2" align="center" valign="middle" class="toplinks"><a href="buynow.php" style="font-size:11px; color:#FF0000; font-weight:bold;" title="BUY IT NOW">BUY IT NOW</a></span> | 
...
<!--   <td width="33%" align="right"><a href="#" id="status" rel="subcontent" title="Language Select"><img src="images/langselect.gif" alt="Language Select" width="124" height="22" border="0" /></a>
...
dropdowncontent.init("status", "right-bottom", 500, 'mouseover')
          ...
          <tr>
            ...
            <td width="88%" align="right" valign="middle">
				...
				<!-- <script type="text/javascript" src="http://cdn.socialtwist.com/2010031436976/script.js"></script>
        ...
        <tr>
          ...
          <td colspan="2" align="center" valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="5">
            ...
            <tr>
              ...
              <td align="center" valign="middle">
              <a href="scheduleademo.php?product=ActiveDirectoryChangeNotifier"><img src="images/header/schedule_demo.png" alt="Take a Test Drive Now"></a>
              </td>
  ...
  <tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <h2><span>CionSystems</span> Solutions</h2>
        ...
        <td width="36%" align="center" style="font-size:12px; font-weight:bold;"> We are available at<br />
          ...
          9:00 AM-6:00 PM (Pacific Standard Time) Mon-Fri  and 9:00 AM-6:00 PM  (India Standard Time) Mon-Fri </td>
...
Microsoft interviews CionSystems founder for channel 9, click on <a href="http://ch9.ms/BVGK" target="_blank" style="font-size:12px; color:#0000FF;">http://ch9.ms/BVGK</a>  to see the interview
    ...
    <td width="8%" style="padding-bottom:5px;"><a href="http://blog.cionsystems.com/?feed=rss2" target="_blank"><img src="images/rssfeed.gif" width="42" height="19" border="0" alt="rss"/></a></td>
      ...
      <tr>
        ...
        <td align="center" valign="middle"><div class="copyright"><dd>Copyright &copy; 2008 CionSystems, Inc. All Rights Reserved.</dd></div></td>
              ...
              <div style="margin:0px auto; width:450px; padding:10px;">



              <img src="images/microsoftlogo.jpg" alt="Microsoft" style="border-right:1px solid #eaeaea;" class="clogo" width="71" height="38" />



              <img src="images/hplogo.jpg" title="Business Partner" class="clogo" style="border-right:1px solid #eaeaea;" width="76" height="51" />



              <img src="images/ibmlogo.jpg" alt="International Business Machines" class="clogo" width="89" height="49" style="border-right:1px solid #eaeaea;" />



              <img src="images/big_spark.jpg" title="Business Partner" class="clogo" width="111" height="46" />              
