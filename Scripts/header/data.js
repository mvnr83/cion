...
objMLB = {
	headlineText: [
		"Dashboards Display configuration and Status in Real Time",
		"Comprehensive Suite of Reports",
		"Easily and Efficiently Manage Group Policy",
		"Workflow Automates and Standardizes Operations",
		"Real Time Notifications for Active Directory Changes",
		"Fined Grained Active Directory Backup and Restore",
                "Migrate and Synchronize On-Premises and Cloud Users",
                "User Self Service and Password Reset Portal",
                "Testimonials"
...
"MLB Tonight is at full speed, with look-ins, analysis, news and highlights from around baseball. Tune in to MLB Network weeknights and Sundays from 5-7 p.m. ET for the action."
	...
	extURL: [
		"http://www.cionsystems.com/Two-Factor-Authentication.php",
		"http://cionsystems.com/active-directory-manager.php",
		"http://cionsystems.com/active-directory-gpomanager.php",
		"http://cionsystems.com/active-directory-manager.php",
		"http://cionsystems.com/active-directory-ChangeNotifier.php",
		"http://cionsystems.com/active-directory-recovery.php",
                "http://cionsystems.com/cim_selfservice.php",
                "http://www.cionsystems.com/Two-Factor-Authentication.php",
                ""
	] // descText
