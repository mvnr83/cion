...
if($rs) 
{
$msg = "<span style='color:#0066FF;'>Email address subscribed to our newsletter</span>";
$smarty->assign("msg",$msg);
}
else
{
$msg = "Email address was not subscribed to our newsletter durring a mysql error";
$smarty->assign("msg",$msg);
}
}
