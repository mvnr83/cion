...
if($_POST['act'] == 'del')
{
	$sql_del = "delete from blogs where id = '".$_POST[uid]."'";
...
if($_POST[act] == 'change')
{
	$sql_up = "update blogs set status = '".$_POST[st]."' where id = '".$_POST[uid]."'";
	$res_up = @mysql_query($sql_up);
	if(@mysql_affected_rows()>0)
		$msg = "Status changed Successfully";
		
}
$sql_sel = "select * from blogs";
...
$content=$smarty->fetch("viewblogs.tpl");
