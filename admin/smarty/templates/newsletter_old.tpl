                      ...
                      <td align="left" valign="middle"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          ...
                          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="5">
                              ...
                              <tr>
                                <td colspan="4" align="right" valign="middle" ><a href="exportexcel.php"><img src="images/export.gif" width="67" height="19" border="0" /></a></td>
                              </tr>
                              <tr>
                             ...
                             {section name=list loop=$array}
									...
									<tr>
                                     ...
                                     {/section}
									<tr>
									  <td colspan="4" align="center" class="aril">{$pagination}</td>
						    </tr>
                          </table></td>
