...
{
	var op = window.open("menudetails.php?uid="+id, "mywin","menubar=0,resizable=1,width=450,height=400")
	op.focus();
}
function editmenu(id)
{
	var frm = document.form1;
	frm.action = "editmenu.php?uid="+id;
	frm.submit();
}
function delmenu(id)
{
	var frm = document.form1;
	if(confirm("Are you sure,Do you want to delete this Privilege"))
	{
		frm.act.value = 'del';
		frm.uid.value = id;
		frm.action = 'viewmenus.php';
		frm.submit();
	}
}
                      ...
                      <td align="left" valign="middle"><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" background="images/login_bg.gif">
                              <tr>
                                <td height="29" align="center" valign="middle" class="wite">View Menus </td>
                              </tr>
                          </table></td>
                        </tr>
                        <tr>
                          <td align="left" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
								...
								<td align="center" valign="middle" class="Sub_menu">Privilege Name </td>
								<td align="center" valign="middle" class="Sub_menu">Related To </td>
                             ...
                             {section name=list loop=$array}
									<tr>
										...
										<td class="aril" align="center">{$array[list].privilege_name}</td>
										<td class="aril" align="center">{$array[list].related_to}</td>
										...
										<td class="aril" align="center"><img src="images/b_view.png"  width="16"/ onclick="javascript:showmenu('{$array[list].id}')" style="cursor:hand"  title="View Menu Details"> / <img src="images/b_edit.png" width="20" onclick="javascript:editmenu('{$array[list].id}')" style="cursor:hand"  title="Edit Menu"/></td>
										<td class="aril" align="center"><img src="images/b_drop.png" onclick="javascript:delmenu('{$array[list].id}')" style="cursor:hand" title="Delete Menu" /></td>
									</tr>
							 {/section}
