...
function remind(id){
	var op = window.open("cmt_remind.php?uid="+id, "mywin","menubar=0,resizable=1,width=480,height=300")
	op.focus();
}
                        ...
                        <tr>
                          ...
                          <td align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" background="images/login_bg.gif">
                              ...
                              <tr>
                                ...
                                <td height="29" align="center" valign="middle" class="wite">CMT Members &nbsp; {$total_members}</td>
                            </tr>
                        ...
                        <tr>
                          ...
                          <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
                              ...
                              <tr>
								...
								<td align="center" valign="middle" class="Sub_menu">Number of Users</td>
                             ...
                             {section name=list loop=$array}
									...
									<tr>
										...
										<td class="aril" align="center">{$array[list].firstname}</td>
										<td class="aril" align="center">{$array[list].lastname}</td>
										<td class="aril" align="center">{$array[list].companyname}</td>
										<td class="aril" align="center">{$array[list].numberofusers}</td>
										<td class="aril" align="center">{$array[list].country}</td>

										<td class="aril" align="center">{$array[list].emailaddress}</td>

									    <td class="aril" align="center">{$array[list].phonenumber}</td>
								        <td class="aril" align="center">{$array[list].dates}</td>
								        <td class="aril" align="center">{if $array[list].remind == ''} <img src="images/view_remind_gray.gif" alt=""  width="16" style="cursor:hand"  title="View User Details"/ onclick="javascript:remind('{$array[list].id}')" /> {else} <img src="images/view_remind.gif" alt=""  width="16" style="cursor:hand"  title="View User Details"/ onclick="javascript:remind('{$array[list].id}')" /> {/if} </td>
