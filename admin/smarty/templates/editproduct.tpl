                        ...
                        <tr>
                          <td align="left" valign="top"><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                              ...
                              <tr>
                                ...
                                <td align="center" valign="middle">&nbsp;</td>
                                <td align="left" valign="middle">{$array[0].product_code}</td>
                                <td align="left" valign="middle">&nbsp;</td>
                              </tr>
							  <tr>
                                <td align="right" valign="middle" class="aril">Product Name :</td>
                                <td align="center" valign="middle">&nbsp;</td>
                                <td height="25" align="left" valign="middle"><input name="pname" type="text" class="fieldwidth" value="{$array[0].product_name}" /></td>
                                <td align="left" valign="middle">&nbsp;</td>
                              </tr>
                               <tr>
                                <td align="right" valign="middle" class="aril">Short Description  :</td>
                                <td align="center" valign="middle">&nbsp;</td>
                                <td align="left" valign="middle"><textarea rows="3" cols="30" name="sdec">{$array[0].short_description}</textarea></td>
                                <td align="left" valign="middle">&nbsp;</td>
                              </tr>
							  <tr>
							  ...
							  <tr>
                                ...
                                <td align="center" valign="middle">&nbsp;</td>
                                <td align="left" valign="middle"><img src="../original/{$array[0].original_file_path}" name="im2" /><br /><input name="ofpath" type="file" /></td>
                                <td align="left" valign="middle">&nbsp;</td>
                              </tr>
							  <tr>
                                <td align="right" valign="middle" class="aril">Home Product Image  :</td>
                                <td align="center" valign="middle">&nbsp;</td>
                                <td height="25" align="left" valign="middle"><img src="../product_images/{$array[0].product_image}" name="im3" /><br /><input name="home_img" type="file" /></td>
                                <td align="left" valign="middle">&nbsp;</td>
                              </tr>
							  <tr>
                                <td align="right" valign="middle" class="aril">Download Product Image  :</td>
                                <td align="center" valign="middle">&nbsp;</td>
                                <td height="25" align="left" valign="middle"><img src="../download_images/{$array[0].download_image}" name="im3" /><br /><input name="download_img" type="file" /></td>
                                <td align="left" valign="middle">&nbsp;</td>
                              </tr>
							 <tr>
