...
function remind(id){
	var op = window.open("remind_newsletter.php?uid="+id, "mywin","menubar=0,resizable=1,width=480,height=300")
	op.focus();
}
                      ...
                      <td align="left" valign="middle"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          ...
                          <td align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" background="images/login_bg.gif">
                              ...
                              <tr>
                                ...
                                <td height="29" align="center" valign="middle" class="wite">NewLetter Members &nbsp; {$total_members}</td>
                              </tr>
                        ...
                        <tr>
                          ...
                          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="5">
                              ...
                              <tr>
                                <td colspan="6" align="right" valign="middle" ><a href="exportexcel.php"><img src="images/export.gif" width="67" height="19" border="0" /></a></td>
                              </tr>
                              <tr>
                             ...
                             {section name=list loop=$array}
									...
									<tr>
									    ...
									    <td align="center" valign="middle" class="aril">{$array[list].dates}</td>
									    <td align="center" valign="middle" class="aril">
                                     ...
                                     {/section}
									<tr>
									  <td colspan="6" align="center" class="aril">{$pagination}</td>
						    </tr>
                          </table></td>
