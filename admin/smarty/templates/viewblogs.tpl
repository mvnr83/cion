...
{
	var op = window.open("blogdetails.php?bid="+id, "mywin","menubar=0,resizable=1,scrollbars=yes,width=750,height=700")
	op.focus();
}
function editblog(id)
{
	var frm = document.form1;
	frm.action = "editblog.php?uid="+id;
	frm.submit();
}
function delblog(id)
{
                      ...
                      <td align="left" valign="middle"><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" background="images/login_bg.gif">
                              <tr>
                                <td height="29" align="center" valign="middle" class="wite">View Blogs </td>
                              </tr>
                          </table></td>
                        </tr>
                        <tr>
                          <td align="left" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
								...
								<td align="center" valign="middle" class="Sub_menu">Blog Title </td>
								<td align="center" valign="middle" class="Sub_menu">Blog Author </td>
                             ...
                             {section name=list loop=$array}
									<tr>
										...
										<td class="aril" align="center">{$array[list].blog_title}</td>
										...
										<td class="aril" align="center"><img src="images/b_view.png"  width="16"/ onclick="javascript:showblog('{$array[list].id}')" style="cursor:hand" title="View Blog Details"> / <img src="images/b_edit.png" width="20" onclick="javascript:editblog('{$array[list].id}')" style="cursor:hand"  title="Edit Blog"/></td>
										<td class="aril" align="center"><img src="images/b_drop.png" onclick="javascript:delblog('{$array[list].id}')" style="cursor:hand" title="Delete Blog" /></td>
									</tr>
							 {/section}
