                      ...
                      <td align="left" valign="middle"><table width="408" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td align="left" valign="top"><table width="700" border="0" align="left" cellpadding="0" cellspacing="0" background="images/login_bg.gif">
                              <tr>
                                <td height="29" align="center" valign="middle" class="wite">Edit Blog </td>
                              </tr>
                          </table></td>
                        </tr>
                        <tr>
						  ...
						  <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
                              ...
                              <tr>
                                <td align="right" valign="middle" class="aril">Choose product :</td>
                                <td align="center" valign="middle">&nbsp;</td>
                                <td align="left" valign="middle">
								<select name="product">
								<option value="">----Select----</option>
								{section name=cust loop=$products}
								<option value="{$products[cust].id}" {if $products[cust].id eq $array[cust].product_id}selected{/if}>{$products[cust].product_name}</option>
								{/section}
								</select>
								</td>
                                <td align="left" valign="middle">&nbsp;</td> 	
                              ...
                              <tr>
                                <td align="right" valign="middle" class="aril">Blog Name:</td>
                                <td align="center" valign="middle">&nbsp;</td>
                                <td height="25" align="left" valign="middle">
								<input name="bname" type="text" class="fieldwidth" id="bname" value="{$array[0].blog_title}"/></td>
                                <td align="left" valign="middle">&nbsp;</td>
                              </tr>
                              <tr>
                                ...
                                <td align="center" valign="middle">&nbsp;</td>
                                <td height="25" align="left" valign="middle">
								<textarea name="textarea1">{$array[0].blog_description}</textarea>
								</td>
                                <td align="left" valign="middle">&nbsp;</td>
                              </tr>
							  <tr>
