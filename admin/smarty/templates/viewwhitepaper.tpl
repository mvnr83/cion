...

{
	...
	var op = window.open("whitepaperdetails.php?uid="+id, "mywin","menubar=0,resizable=1,width=450,height=400")
...

{
	...
	frm.action = "editwhitepapers.php?uid="+id;
...

{
...

	{
		...
		frm.action = 'viewwhitepapers.php';
                        ...
                        <tr>
                          ...
                          <td align="left" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                              ...
                              <tr>
								...
								<td align="center" valign="middle" class="Sub_menu">WhitePaper Title </td>

								<td align="center" valign="middle" class="Sub_menu">WhitePaper Path </td>
                             ...
                             {section name=list loop=$array}
									...
									<tr>
										...
										<td class="aril" align="center">{$array[list].wp_name}</td>

										<td class="aril" align="center"><a href="download.php?filename={$array[list].wp_path}" class="Sub_menu">{$array[list].wp_path}</a></td>
