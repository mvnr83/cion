					  ...
					  <table width="408" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
						  ...
						  <table width="700" border="0" align="left" cellpadding="0" cellspacing="0" background="images/login_bg.gif">
                              <tr>
                                <td height="29" align="center" valign="middle" class="wite">Add Blog </td>
                              </tr>
                          </table></td>
                        </tr>
                        <tr>
						  ...
						  <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
                              ...
                              <tr height="35">
								...
								<option value="{$products[cust].id}">{$products[cust].product_name}</option>
								{/section}
								</select>
								</td>
                                <td align="left" valign="middle">&nbsp;</td> 	
                              ...
                              <tr height="35">
								...
								<input name="bname" type="text" class="fieldwidth" id="bname" /></td>
                                <td align="left" valign="middle">&nbsp;</td>
                              </tr>
                              <tr>
