...
function check()
{
	...
	if(frm.pname.value == '')
	{
		alert("Enter Privilege Name");
		frm.pname.focus();
		return false;
	}
	else if(frm.rel.value == '')
	{
		alert("Select Related To");
		frm.rel.focus();
		return false;
	}
                      ...
                      <td align="left" valign="middle"><table width="408" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td align="left" valign="top"><table width="409" border="0" align="left" cellpadding="0" cellspacing="0" background="images/login_bg.gif">
                              <tr>
                                <td height="29" align="center" valign="middle" class="wite">Edit Menu </td>
                              </tr>
                          </table></td>
                        </tr>
                        <tr>
                          <td align="left" valign="top"><table width="410" border="0" align="center" cellpadding="0" cellspacing="0">
                              ...
                              <tr>
                                <td align="right" valign="middle" class="aril">Privilege Name:</td>
                                <td align="center" valign="middle">&nbsp;</td>
                                <td height="25" align="left" valign="middle"><input name="pname" type="text" class="fieldwidth" value="{$array[0].privilege_name}"/></td>
                                <td align="left" valign="middle">&nbsp;</td>
                              </tr>
                              <tr>
                                <td align="right" valign="middle" class="aril">Related To  :</td>
                                <td align="center" valign="middle">&nbsp;</td>
                                <td height="25" align="left" valign="middle"><select name="rel">
								<option value="">Select</option>
								<option value="client" {if $array[0].related_to == 'client'} selected{/if}>Site</option>
								<option value="Admin" {if $array[0].related_to == 'admin'}selected{/if}>Admin</option>
								</select></td>
                                <td align="left" valign="middle">&nbsp;</td>
                              </tr>
							  <tr>
