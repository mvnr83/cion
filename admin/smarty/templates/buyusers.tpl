...

{
	...
	var op = window.open("buyuserdetails.php?uid="+buy_id, "mywin","menubar=0,resizable=1,width=650,height=500")
                      ...
                      <td align="left" valign="middle"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          ...
                          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="5">
                              ...
                              <tr>
                                <td colspan="8" align="right" valign="middle" ><a href="exportbuy.php"><img src="images/export.gif" width="67" height="19" border="0" /></a></td>
                              </tr>
                              <tr>
                             ...
                             {section name=list loop=$array}
									...
									<tr>
                                        ...
                                        <td class="aril" align="center"><img src="images/b_view.png"  width="16"/ onclick="javascript:showbuyuser('{$array[list].buy_id}')" style="cursor:pointer;" title="View Buy Users"></td>
