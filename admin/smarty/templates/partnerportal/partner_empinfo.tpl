...

{
	...
	var op = window.open("view_emp.php?uid="+id, "mywin","menubar=0,resizable=1,width=480,height=400")
                        ...
                        <tr>
                          ...
                          <td align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" background="images/login_bg.gif">
                              ...
                              <tr>
                                ...
                                <td height="29" align="center" valign="middle" class="wite">Users Info</td>
                            </tr>
                        ...
                        <tr>
                          ...
                          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                              ...
                              <tr>
								...
								<th align="center" valign="middle" class="Sub_menu">User Name </th>

								<th align="center" valign="middle" class="Sub_menu">Password</th>

								<th align="center" valign="middle" class="Sub_menu">First Name</th>

								<th align="center" valign="middle" class="Sub_menu">Last Name</th>

							    <th align="center" valign="middle" class="Sub_menu">Joined Date</th>
							    <th align="center" valign="middle" class="Sub_menu">Status</th>

								<th align="center" valign="middle" class="Sub_menu">Edit Status</th>
...
{else}
        ...
        <td class="aril" align="center">{$smarty.section.list.rownum}</td>
										...
										<td class="aril" align="center" height="25">{$array[list].username}</td>
										...
										<td class="aril" align="center"><img src="images/b_edit.png" width="20" onclick="javascript:edituser('{$array[list].emp_id}')" style="cursor:pointer"  title="Edit Details"></td>
										<td class="aril" align="center"><img src="images/b_view.png"  width="16"/ onclick="javascript:showuser('{$array[list].emp_id}')" style="cursor:pointer"  title="View User Details"> </td>

										<td class="aril" align="center"><img src="images/b_drop.png" onclick="javascript:deluser('{$array[list].emp_id}')" style="cursor:pointer" title="Delete User" /></td>
									</tr>
							 ...
							 {/section}
                              ...
                              <tr>
                                ...
                                <td align="center" valign="middle" colspan="11">{$pagination}</td>
                            </tr>
                          </table></td>
                        </tr>
