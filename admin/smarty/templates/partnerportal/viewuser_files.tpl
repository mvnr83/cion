...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                -->
                              ...
                              <tr>
                                <td align="right" valign="middle" nowrap="nowrap" class="Sub_menu">User Name :</td>
                                <td align="left" valign="middle" class="aril"><strong>{$company[0].username}</strong></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td align="left" valign="middle" class="aril">{$array[0].Ufiles}</td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td align="left" valign="middle" class="aril">{$array[0].Ustatus}</td>
                              </tr>
                              <tr>
                                <td align="right" class="Sub_menu">Date :</td>
                                <td align="left" valign="middle" class="aril">{$array[0].Udate|date_format:"%D"}</td>
                              </tr>
