...

{
	...
	var op = window.open("viewuser_files.php?uid="+id, "mywin","menubar=0,resizable=1,width=480,height=400")
                        ...
                        <tr>
                          ...
                          <td align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" background="images/login_bg.gif">
                              ...
                              <tr>
                                ...
                                <td height="29" align="center" valign="middle" class="wite">Files Uploaded for Users</td>
                              </tr>
...
{if $array[list].status == 'Inactive'}
        ...
        <td height="25" align="center" class="aril">{$smarty.section.list.rownum}</td>
										...
										<td class="aril" align="center">{$comp[list].username}</td>
							  <td class="aril" align="center">{$array[list].Title}</td>

										<td class="aril" align="center">{if $array[list].filetype == 'image'}
                                          <a href="upload_file/{$array[list].Ufiles}" target="_blank">View Image</a> 
                                          {else}
                              			<a href="doc_download.php?filename={$array[list].Ufiles}">Download</a>    
                              			{/if}                              			</td>
                                        
							  <td class="aril" align="center">{$array[list].Udate|date_format:"%D"}</td>
										<td class="aril" align="center">
                                        {if $array[list].Ustatus == 'Active'}<a href="javascript:changestat('{$array[list].Uid}','Inactive');" class="Sub_menu">Make In Active</a>{else}<a href="javascript:changestat('{$array[list].Uid}','Active');" class="Sub_menu">Make Active</a>{/if}
                                        </td>

										<td class="aril" align="center"><img src="images/b_view.png"  width="16"/ onclick="javascript:showuser('{$array[list].Uid}')" style="cursor:pointer"  title="View User Details"> </td>

										<td class="aril" align="center"><img src="images/b_drop.png" onclick="javascript:deluser('{$array[list].Uid}')" style="cursor:pointer" title="Delete User" /></td>
									</tr>
