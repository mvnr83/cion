  ...
  <table width="100%" border="0" cellspacing="5" cellpadding="0">
    ...
    <tr>
      <td valign="top" style="border:1px solid #d4ddec" width="400"><table width="100%" border="0" cellspacing="5" cellpadding="0" >
        <tr>
          <td height="30" colspan="2" bgcolor="#d4ddec" style="padding-left:10px;"><strong>Personal Information : </strong></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td align="left" valign="middle"><select name="country" class="ari" style="width:150px">
        ...
        <tr>
          ...
          <td width="50%" align="left"><select name="status">
            <option value="" >Select</option>
      ...
      <td valign="top" width="300" style="border:1px solid #d4ddec"><table width="100%" border="0" cellspacing="5" cellpadding="0">
        <tr>
          <td width="70" height="30" colspan="2" bgcolor="#d4ddec" style="padding-left:10px;"><strong>Company Information : </strong></td>
        </tr>
        ...
        <tr>
          <td align="right" valign="middle"  >Job Title : </td>
          <td align="left" valign="middle"><select name="jtitle" class="ari" style="width:150px">
              <option  value="">---Select---</option>
        ...
        <tr>
          <td align="right" valign="middle"  >Industry : </td>
          <td align="left" valign="middle"><select name="industry" class="ari" style="width:150px;">
              <option  value="">---Select---</option>
