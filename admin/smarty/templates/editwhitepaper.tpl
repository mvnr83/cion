	...
	<td align="center" class="Sub_menu" colspan="3">{$msg}</td>
				...
				<input name="uid" type="hidden" value="{$uid}" />
                  <table width="417" border="0" align="center" cellpadding="0" cellspacing="0" class="stroke">
                    ...
                    <tr>
                      <td align="left" valign="middle"><table width="408" border="0" align="center" cellpadding="0" cellspacing="2">
                        <tr>
                        ...
                        <tr>
                          <td align="left" valign="top"><table width="450" border="0" align="center" cellpadding="0" cellspacing="3">
                              <tr>
                              ...
                              <tr>
                                <td align="right" valign="middle" class="aril">WhitePaper Title  :</td>
                                <td align="center" valign="middle">&nbsp;</td>
                                <td height="25" align="left" valign="middle">
                                <input name="title" type="text" value="{$array[0].wp_name}" /></td>
                                <td align="left" valign="middle">&nbsp;</td>
                              </tr>
                              <tr>
                                <td align="right" valign="middle" class="aril">Uploaded WhitePaper</td>
                                <td align="center" valign="middle">&nbsp;</td>
                                <td align="left" valign="middle" class="aril">{$array[0].wp_path}</td>
                                <td align="left" valign="middle">&nbsp;</td>
                              </tr>
                              <tr>
                                <td align="right" valign="middle" class="aril">WhitePaper Path  :</td>
                                <td align="center" valign="middle">&nbsp;</td>
                                <td align="left" valign="middle"><input name="path" type="file" class="Sub_menu" value="{$array[0].wp_path}"/></td>
                                <td align="left" valign="middle">&nbsp;</td>
                              </tr>
							 <tr>
