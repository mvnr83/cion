...
if($_POST[act] == 'edit')
{
	...
	$sql_up = "update product_details set product_type='".$_POST[product_type]."', product_name = '".$_POST[pname]."',short_description = '".addslashes($_POST[sdec])."',html_file_name = '".$_POST[hfname]."',status = '".$_POST[status]."'";
