...
if($_POST['act'] == 'del')
{
	$sql_del = "delete from partner_market where Pid = '".$_POST[uid]."'";
...
if($_POST[act] == 'change')
{
	$sql_up = "update partner_market set Pstatus = '".$_POST[st]."' where Pid = '".$_POST[uid]."'";
	$res_up = @mysql_query($sql_up);
	if(@mysql_affected_rows()>0)
		$msg = "Status changed Successfully";
		
}
$sql_sel = "select * from partner_market";
...
/*Pagination */
$tbl_name="partner_market";		//your table name
...
/* Setup vars for query. */
	$targetpage = "partner_files.php"; 	//your file name  (the name of this file)
...
/* Get data. */
	$sql = "SELECT * FROM $tbl_name ORDER BY Pdate DESC LIMIT $start, $limit";
...
$content=$smarty->fetch("partnerportal/partner_files.tpl");
