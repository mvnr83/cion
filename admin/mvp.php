...
if($_POST['act'] == 'del')
{
	$sql_del = "delete from mvp where id = '".$_POST[uid]."'";
...
$tot_count = 0;
$sql_sel = "select * from mvp";
$res_sel = @mysql_query($sql_sel);
$array= array();
$rowcount = 0;

/*Pagination */
$tbl_name="mvp";		//your table name
...
/* Setup vars for query. */
	$targetpage = "mvp.php"; 	//your file name  (the name of this file)
