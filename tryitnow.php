...
{
$sql = "select user_name,id,first_name,last_name,email from users where user_name = '".$_SESSION['username']."'";
	$res = @mysql_query($sql);
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #006699;">
  ...
  <tr>
    <td height="86" style="padding:10px;"><p>Thank you for registering and downloading the CionSystems '.$fetch[product_name].'. A sales representative will be contacting you shortly to discuss the challenges facing you and your organization and how we can help. In the meantime, please feel free to download this evaluation version to gain more knowledge about the   benefits and features of our Active Directory management solutions.</p></td>
  </tr>
  ';
			...
			<tr>
				<td style="padding:10px;">See the viedo for installation process :<br />
			...
			'<tr>
				<td style="padding:10px;">Please review the requirements and our Quick Start guide, before installing the application:<br />
				<a href="http://www.cionsystems.com/trial/ADManagerPro_QuickStart_Guide.pdf"><img src="http://www.cionsystems.com/images/quickstart.gif" alt="Quick Start Guide" border="0" /></a></td>
			</tr>
			...
			'<tr>
				<td style="padding:10px;">Please review the requirements and our Quick Start guide, before installing the application:<br />
				<a href="http://www.cionsystems.com/trial/ADRecoveryQuickStartGuide.pdf"><img src="http://www.cionsystems.com/images/quickstart.gif" alt="Quick Start Guide" border="0" /></a>
				
				</td>
			</tr>
			<tr>
				<td style="padding:10px;">See the viedo for installation process :<br />
				<a href="http://www.cionsystems.com/production/adrecovery/adrecovery.html"><img src="http://www.cionsystems.com/images/video.gif" alt="See the video" border="0" /></a>
  ...
  <tr>
    <td height="45" style="padding:10px;"><a href="http://www.cionsystems.com/downloadpage.php?id='.$key.'&pcode='.$_POST['pname'].'&user='.$row[id].'"><img src="http://www.cionsystems.com/images/trial_download.gif" alt="Download Free Trial" border="0" /></a>
