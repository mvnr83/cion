...
if($fetch[product_code]=="sic"){$message.='please feel free to download this evaluation version to gain more knowledge about the benefits and features of our management solutions.</p></td>
			...
			'<tr>
				...
				<td style="padding:10px;">Please review the INSTALLATION requirements in the Quick Start guide, before installing the application:<br />
			...
			'<tr>
				...
				<a href="http://www.cionsystems.com/trial/ADR_Quick_Start_v2.1.pdf"><img src="http://www.cionsystems.com/images/quickstart.gif" alt="Quick Start Guide" border="0" /></a></td>
			...
			'<tr>
				...
				<a href="http://www.cionsystems.com/trial/provisioning_quick_start.pdf"><img src="http://www.cionsystems.com/images/quickstart.gif" alt="Quick Start Guide" border="0" /></a></td>
			...
			else if($fetch[product_code] == "adgpo")
			...
			'<tr>
				...
				<a href="http://www.cionsystems.com/trial/GPOManager_quickstart_guide_2.0.pdf"><img src="http://www.cionsystems.com/images/quickstart.gif" alt="Quick Start Guide" border="0" /></a></td>
  ...
  <tr>
    ...
    <p>For additional support, please feel free to send an email to: support@cionsystems.com
