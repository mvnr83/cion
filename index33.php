...
<title>Active Directory Management | Exchange | CionSystems | Cion |  Seattle | Azure| Office 365</title>
...
'>
<meta name='description' content='CionSystems offers easy to use web based, Active Directory management solutions and tools that help
 IT organizations manage password changes, resets, account lockouts, user, computer provisioning and de-provisioning, group management,
  Exchange, auditing, delegation, compliance.'>
  ...
  <div class="navbar navbar-default  ">
    ...
    <div class="navbar-collapse collapse">
      ...
      <ul class="nav navbar-nav">
		...
		<li> <a href="solution_all.php" class="trigger" title="Solutions">Solutions <i class="fa fa-angle-down"></i></a>
        ...
        <li class="dropdown"> 
        <a data-toggle="dropdown" href="solution_all.php">Solutions <i class="fa fa-angle-down"></i> </a>
          <ul class="dropdown-menu">
		...
		<a class="dropdown-toggle" data-close-others="false" data-delay="0" data-hover="dropdown" role="button"
					  data-toggle="dropdown" href="www.cionsystems.com/active-directory-tools.php">
...
<li> <a href="office365_bundle.php" tabindex="-1">Office 365 | Azure Management Simplified</a> </li>
        ...
        <li class="dropdown"> <a class="dropdown-toggle" data-close-others="false" data-delay="0" data-hover=
                      "dropdown" data-toggle="dropdown" href="active-directory-tools.php">Downloads <i class="fa fa-angle-down"></i> </a>
          <ul class="dropdown-menu">
        ...
        <li class="dropdown"> <a class="dropdown-toggle" data-close-others="false" data-delay="0" data-hover=
                      "dropdown" data-toggle="dropdown" href="partners.php">Partners <i class="fa fa-angle-down"></i> </a>
          <ul class="dropdown-menu">
        ...
        <li class="dropdown"> <a class="dropdown-toggle" data-close-others="false" data-delay="0" data-hover=
                      "dropdown" data-toggle="dropdown" href="aboutus.php">Company <i class="fa fa-angle-down"></i> </a>
          <ul class="dropdown-menu">
