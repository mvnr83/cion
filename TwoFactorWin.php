...
$get_product = mysql_fetch_array(mysql_query("select * from product_details where id='19' and status='Active'"));
$get_product_ESS = mysql_fetch_array(mysql_query("select * from product_details where id='19' and status='Active'"));
...
$smarty->assign("pname_ess",$get_product_ESS['product_name']);

$smarty->assign("product_id_ess",$get_product_ESS['id']);
...
$content=$smarty->fetch("TwoFactorWin.tpl");
