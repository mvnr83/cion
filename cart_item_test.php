...
Up to 500 Users -- $<?php echo $get_product['price_500users'];?></td>
  ...
  <tr>
    <td colspan="2"><input type="radio" name="product" id="product" value="PRO" checked="checked" onclick="javascript: ProVal('pro');"/>	<input type="checkbox" name="product" id="product" value="PRO" checked="checked" onclick="javascript: ProVal('pro');"/>	
      <strong>Active Directory Manager Pro - Annual Subscription</strong></td>
  </tr>
  <tr>
    <td><label>Number of Users</label></td>
    <td><input type="radio" name="noofusers" id="noofusers" value="250" checked="checked"/>
