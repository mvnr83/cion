                ...
                <td ><input type="hidden" name="keyword" id="keyword" />
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                    <tr>
                      ...
                      <td  width="30%">
                      	<div class="greybox" style="height:381px;background:#EDEDED; -webkit-border-radius: 0;border-radius:0;">
                          <div style="margin-top:30%">
                            ...
                            <div align="right" style="padding:5px;"><em><strong>Kevin</strong><br>
                              IT Director, UCAN</em></div>
                          </div>
                        </div></td>
                    </tr>
                  </table></td>
              ...
              <tr>
                <td><table width="99%" border="0" cellspacing="0" cellpadding="5" style="margin-top:5px;">
                    <tr>
                      ...
                      <div class="greybox" style="height:280px; width:98%; border:solid 1px #ccc;-webkit-border-radius: 0;border-radius: 0;">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                            ...
                            <tr>
                              <td><div id="marqueecontainer" onMouseover="copyspeed=pausespeed" onMouseout="copyspeed=marqueespeed" style="height:230px;">
                                  <div id="vmarquee" style="position: absolute; width: 100%;"> 
                                    ...
                                    <a href="http://cionsystems.com/press/index-17.html" style="text-decoration:none;" onMouseOver="style.fontWeight = 'bold'" onMouseOut="style.fontWeight = 'normal'" title="June 19, 2014: CionSystems ReleasesActive Directory Manager Reporter version 5.0">June 19, 2014: CionSystems Releases Active Directory Reporter version 5.0</a><br />
                                    <br />
                                    <a href="http://cionsystems.com/press/index-16.html" style="text-decoration:none;" onMouseOver="style.fontWeight = 'bold'" onMouseOut="style.fontWeight = 'normal'" title="June 12, 2014: CionSystems ReleasesActive Directory Manager Pro version 5.0">June 12, 2014: CionSystems Releases Active Directory Manager Pro version 5.0</a><br />
                                    <br />
