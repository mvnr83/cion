...
unset($_SESSION['security_code']);   
...

	{
		...
		$msg = 'Please retrieve your details by clicking <a href="forgotpassword.php">Forgot Credentials</a> or use a different user name';

		$smarty->assign("msg",$msg);

	} else if(@mysql_num_rows($sql_email_chk)>0)

	{

		$msg = 'Email address is associated with other user account, use a different email id or retrieve your details by clicking <a href="forgotpassword.php">Forgot Credentials</a>';
