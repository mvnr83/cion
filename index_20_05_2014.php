...
<link href="style/style.css" rel="stylesheet" media="all" /><link href="style/slider1.css" rel="stylesheet" media="all" />
...
-->
                 ...
                 <input type="hidden" name="keyword" id="keyword" />
                   ...
                   <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                    ...
                    <tr>
                      ...
                      <td valign="top" style="background:url(images/dottedline.gif) no-repeat right center" width="70%">
                                            <div class="headerslider" style="background-color:#669BCD;">
        <div class="navigator">
        ...
        <ul id="slider" class="slider">
            ...
            <li class="slide5" style="display: none;" onclick="NavigateTo('http://www.cionsystems.com/services.php')"></li>
                      ...
                      <td  width="30%">
                                            <div class="greybox" style="height:395px;background:#EDEDED">
                      

                      <div style="margin-top:30%">
                      <p style="font-size:13;color:#626262;text-align:justify;font-weight:bold">"As it turned out AD Reporter and the notifications was a great help in troubleshooting the locking account. The change notification pointed us to the origin of failed authentications of Exchange. AD Reporter revealed the exact schedule and frequency that the account was locking. Between these 2-pieces of information, a conversation with the user pointed us to directly to the application that was setup with his out dated credentials"</p>
                      <div align="right" style="padding:5px;"><em><strong>Kevin</strong><br>IT Director, UCAN</em></div>
                      </div>
