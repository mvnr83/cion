...
$sql_metatags = "select * from keywords where  id ='14'";
...
{
	$metakeywords = 'Active Directory Manager, AD Reporter, Remote Manager, Active Directory Change Notifier, System Information & Comparison, CionSystems, Windows, IT management, ROI, optimization, remote access, green computing';
}
...
$content=$smarty->fetch("support_whatdi.tpl");
