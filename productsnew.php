...
<div class="container">
<div class="row"><div class="col-xs-12 "><div class="col-xs-12 maincontentbg"><h1><span>P</span>roducts</h1>
...
<div class="row"><div class="col-xs-12"><div class="col-md-4"><div class="singleproduct"><div class="singleproductinner"><div class="productheader"><a><img src="images/newproducts/productsheader1.jpg" /></a></div>
...
<!-- Modal -->
<div id="myModal" class="modal fade productsmodal" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Active Directory Manager / Active Directory Manager Pro</h4>
      </div>
