...
<link href="style/bigSlide.css" rel="stylesheet" media="all" />
...
<script type="text/javascript" src="Scripts/header/generalNew.js"></script>
...
<table width="900" border="0" cellspacing="0" cellpadding="0">
  ...
  <select name="jumpMenu" id="jumpMenu" onChange="return goto_download(this.value,'<?php echo $name;?>')" style="padding:3px; font-size:12px;">
      ...
      <tr>
  <td align="right">
  <div align="center" style="background:#FC9B20;margin-top:0px;float:right;height:25px;margin-bottom:2px;vertical-align:middle;border:solid 1px #a57901;border-radius:2px;width:85%;"><a href="http://www.cionsystems.com/Two-Factor-Authentication.php" style="font-weight:bold; font-size:15px; text-decoration:none; color:#000000;position:relative;top:25%;">New Release - Office 365, Azure, Self Service and Pwd Management</a>
  </div>
  </td>
  </tr>
              ...
              <tr>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      ...
                      <td width="100%"><!--<h3 style="font-size:18px">Slash more than 75% of your AD Management cost</h3>-->
                      <div class="greybox" style="height:80px;background:#EDEDED">
                      <div>
                      <strong>"</strong><span style="font-size:13;color:#626262;font-weight:bold">Worked with CionSystem’s solutions over the past 6 months, it is refreshing to use well designed, light weight solutions that help solve some of the more troubling dilemmas with Active Directory.  I get the feeling they’re team has real world experience with Active Directory, and the business requirements that most of us in IT are faced with.</span><strong>"</strong>
                      <div align="right" style="margin-top:10px;padding:5px;"><em><strong>Pete</strong><br>IT Manager, Tecplot Inc.</em></div>
                      </div>
          ...
          <!--              <a href="http://www.cionsystems.com/LiveSupport/client.php?locale=en" target="_blank" onClick="if(navigator.userAgent.toLowerCase().indexOf('opera') != -1 && window.event.preventDefault) window.event.preventDefault();this.newWindow = window.open('http://www.cionsystems.com/LiveSupport/client.php?locale=en&url='+escape(document.location.href)+'&referrer='+escape(document.referrer), 'webim', 'toolbar=0,scrollbars=0,location=0,status=1,menubar=0,width=640,height=480,resizable=1');this.newWindow.focus();this.newWindow.opener=window;return false;">
              ...
              <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #EDEDED;">
                    ...
                    <tr>
                      ...
                      <td width="99%"><h3 class="h3Color">Active Directory Management and Monitorring:</h3>
                        ...
                        <div class="list">
                          ...
                          <ul>
                            ...
                            <li><a href="active-directory-recovery.php"><img src="images/bullet1.gif" alt="Backup Restore" />Active Directory Backup and Restore</a></li>

                            <li><a href="active-directory-ChangeNotifier.php"><img src="images/bullet1.gif" alt="Notifier" />Active Directory Change Notifier</a></li>
                      ...
                      <td valign="top" style="background:url(images/dottedline.gif) no-repeat right center" width="98%">
			...
			<div id="description" class="base">
              ...
              <tr>
                ...
                <tr><td colspan="2"><h3>Identity Management, Governance, and Security  Solutions</h3>
                      </td></tr>
                    <tr>

                      <td width="64%" rowspan="2" align="left" valign="top">
