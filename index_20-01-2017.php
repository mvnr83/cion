...
<div id="home-services">
 ...
 <div class="col-md-12" style="background:#ccc; color:#000; font-weight:bold;  padding:5px">Our Test Drive Application Gallery</div>
        <div style="border:solid 1px #ccc; padding:10px; margin-bottom:5px" >
		  ...
		  <div class="col-lg-2" style="padding-top:12px; padding-bottom:0;"><a href="http://admpro.ciontestdrive.com/ActiveDirectoryManager/UserLogin.aspx" > <img src="img/adm_icon.jpg"  width="86px" class="img-responsive"  border="0" ></a></div>
          <!--<div class="col-lg-2" style="padding-top:12px; padding-bottom:0;"> <a href="http://www.ciontestdrive.com/ActiveDirectoryManager/UserLogin.aspx" target="_blank"> <img src="img/adm_icon.jpg"  width="86px" class="img-responsive"  border="0" ></a></div>-->
          <div class="col-lg-2" style="padding-top:12px; padding-bottom:0;"><a href="http://cim.ciontestdrive.com/SelfService/frmUserLogin.aspx" target="_blank"> <img src="img/cim_icon.jpg"  width="86px" class="img-responsive"  border="0" ></a></div>
          <div class="col-lg-3" style="padding-top:12px; padding-bottom:0;"><a href="http://ess.ciontestdrive.com/ADSelfService/frmUserLogin.aspx" target="_blank"> <img src="img/ess_icon.jpg"  width="70px" class="img-responsive"  border="0" ></a></div>
          <div class="col-lg-3"><a href="http://adr.ciontestdrive.com/ADRecoverySetup/UserLogin.aspx" target="_blank"> <img src="img/adr_icon.jpg"  width="76px" class="img-responsive"  border="0" ></a></div>
          </div>
