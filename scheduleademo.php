...
{ 
		...
		$date = date("l, d F, Y, H:i a",time() + ($hourdiff * 3600));			
		 $sql = "insert into demo (product,name,phone,email,company,country,dates) values ('".$_POST['proname']."','".$_POST['first_name']."','".$_POST['phone']."','".addslashes(mysql_real_escape_string($_POST['email']))."','".$_POST['company']."','$country','$date')";
