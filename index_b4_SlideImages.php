  ...
  <li><a href="active-directory-gpomanager.php" title=" Cloud Identity Manager and self service">GPO Manager</a></li>
                        ...
                        <tr>
                          ...
                          <td width="67%" align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                              ...
                              <tr>
                                ...
                                <td align="left" valign="top" class="tabbertab_title" height="25">Microsoft | Office 365</td>

                              </tr>

                              <tr>

                                <td height="30" align="left" valign="middle" class="tabbertab_caption">Simple, Easy-to-use, bi-directional directory synchronization between on premise domain and Microsoft | Office 365</td>
                              ...
                              <tr>
                                ...
                                <ul>
                                  ...
                                  <li style="margin-bottom:5px;">Email migration Microsoft Exchange and others to Microsoft | Office 365</li>
                        ...
                        <tr>
                          ...
                          <td width="67%" align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                              ...
                              <tr>
                                ...
                                <td align="left" valign="top" class="tabbertab_title">Active Directory Manager Pro</td>
		...
		{?>
                                  ...
                                  <?php } ?><?php */?>
                                   ...
                                   <a href="buyitnow.php?product=Ad Manager Pro"><img src="images/header/request_quote.png" width="159" height="38" alt="Active Directory Manager"></a>                                </td>
                          ...
                          <td width="67%" align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                              ...
                              <tr>
                                ...
                                <td align="left" valign="top"><ul>
                                    ...
                                    <li>Restore your AD according to Microsoft's best practices to maintain IT efficiency</li>
		...
		{?>
                                  ...
                                  <?php } ?><?php */?>
                                    ...
                                    <a href="buyitnow.php?product=Ad Recovery"><img src="images/header/request_quote.png" width="159" height="38" alt="Active Directory Recovery"></a>                                </td>
                          ...
                          <td width="67%" align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                              ...
                              <tr>
                                ...
                                <td align="left" valign="top"><ul>
                                    ...
                                    <li>Integrates Microsoft | Office 365</li>
		...
		{?>
                                  ...
                                  <?php } ?><?php */?>
                                   ...
                                   <a href="buyitnow.php?product=Ad Reporter"><img src="images/header/request_quote.png" width="159" height="38" alt="Active Directory Reporter"></a>                                </td>
                        ...
                        <tr>
                          ...
                          <td colspan="2" align="center" valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="5">
                              ...
                              <tr>
                                ...
                                <td align="center" valign="middle"><a href="buyitnow.php?product=AD Change Notifier"><img src="images/header/request_quote.png" width="159" height="38" alt="Active Directory Change Notifier"></a></td>
                        ...
                        <tr>
                          ...
                          <td width="67%" align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                              ...
                              <tr>
                                ...
                                <td align="left" valign="top" height="25" class="tabbertab_title">GPO Manager</td>

                              </tr>

                              <tr>

                                <td height="30" align="left" valign="middle" class="tabbertab_caption">The easiest, most efficient way to manage your organization’s Active Directory Group Policies</td>
                              ...
                              <tr>
                                ...
                                <td align="left" valign="top"><ul>
                                    ...
                                    <li style="margin-bottom:7px;">Integrates and Extends the native Microsoft GPO management tools, eliminates the need to learn third-party interface</li>

                                    <li style="margin-bottom:7px;">Simplifies and automates critical tasks, reduces outages by eliminating manual process and scripts</li>

                                    <li style="margin-bottom:7px;">Helps prove compliance to ITIL, MOF, SOX, Basel II, HIPAA and C-198.</li>

                                   <li style="margin-bottom:7px;">Improves availability and disaster recovery via backup and rollback capabilities.</li>
                                  <!--   <li style="margin-bottom:5px">Simplifies the enforcement of enterprise-wide business policies by enabling streamlined GPO control via workflow.</li>
                                    <li style="margin-bottom:5px">Simplifies and improves network security by restricting access to production GPOs.</li>-->
                          ...
                          <td width="33%" align="right" valign="top"><img src="images/header/adgpo.png" alt="Active Directory Manager" width="259" height="184"></td>

                        </tr>

                        <tr>

                          <td colspan="2" align="center" valign="top"><table border="0" align="center" cellpadding="0" cellspacing="5">

                              <tr>

                                <td align="center" valign="middle">&nbsp;</td>
 <td align="center" valign="middle"><a href="buyitnow.php?product=GPO Manager"><img src="images/header/request_quote.png" alt="Take a Test Drive Now" width="159" height="38"/></a></td>
                              <!--  <td align="center" valign="middle"><a href="scheduleademo.php?product=ActiveDirectoryChangeNotifier"><img src="images/header/schedule_demo.png" alt="Take a Test Drive Now" width="159" height="38"></a> </td> -->

                                <td align="center" valign="middle"><a href="active-directory-gpomanager.php"><img src="images/header/learn_more.png" width="159" height="38" alt="Learn More"></a></td>
...
<td width="58%" align="center" style="background:#fccd4d; border:solid 1px #a57901; font-weight:bold; font-size:12px;"><a href="http://www.cionsystems.com/active-directory-gpomanager.php" style="font-weight:bold; font-size:15px; text-decoration:none; color:#000000">New Release -  Group Policy Manager - Version 3.0.0.0</a></td>  
...
<table width="900" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td align="center" valign="middle"><div class="copyright" style="background:url(images/copyrightbg.gif) repeat-x; background:#333333;">
            ...
            <dd>Copyright &copy; 2012 CionSystems, Inc. All Rights Reserved.</dd>
