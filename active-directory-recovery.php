...
$sql_metatags = "select * from keywords where  id ='9'";
...
$get_product = mysql_fetch_array(mysql_query("select * from product_details where id='12' and status='Active'"));
...
$content=$smarty->fetch("products_recovery.tpl");
